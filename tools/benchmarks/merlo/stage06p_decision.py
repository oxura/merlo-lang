...
from tools.benchmarks.merlo.stage06p_protocol import STAGE06P_DECISIONS
...
def write_stage06p_decision(root: str | Path = ".") -> dict[str, Any]:
    ...
    destination = root_path / "tools" / "benchmarks" / "merlo" / "benchmarks" / STAGE06P_DECISION_FILENAME
