...
def run_ergonomics_experiment(
    *,
    benchmark_dir: str | Path = "tools/benchmarks/merlo/benchmarks/stage06p_benchmark/corpus",
    extended_dir: str | Path = "tools/benchmarks/merlo/benchmarks/stage06p_extended/corpus",
    output_path: str | Path = "tools/benchmarks/merlo/benchmarks/meldra_stage06p_ergonomics.json",
) -> dict[str, Any]:
