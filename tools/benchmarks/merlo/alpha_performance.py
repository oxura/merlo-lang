...
from tools.benchmarks.merlo.productive_performance import ArmMeasurement, FROZEN_WORKLOADS as PRODUCTIVE_WORKLOADS
from tools.benchmarks.merlo.productive_performance import build_productive_runner_registry
...
FROZEN_WORKLOADS: tuple[FrozenWorkload, ...] = (
    FrozenWorkload(
        ...
        "tools/benchmarks/merlo/benchmarks/productive_performance/csv/workload.csv", 182104,
        ...
        "parse numeric columns and sum each row into one deterministic digest",
        {
            ...
            "merlo_canonical": "5ceb3de3ff20dbeeb6f7bab8be1ec9d073bde3601ca9ae47cd677327cf114b61",
            "c": "2c3fd15da202b4d9856388947bafbdce7eaf1198df3c6e448cab5d27d469c683",
            "python": "198fef039642b9b90ab8246dc47e12cf3b7ced9a16a8a806c359dba340feb22b",
    ...
    FrozenWorkload(
        ...
        "tools/benchmarks/merlo/benchmarks/productive_performance/grep/workload.txt", 286389,
        ...
        {
            "merlo_concise": "ba910522cca55f18510406a3fe0d3ddee0cff48b889b34b5be66d2faf3e7f0ad",
            "merlo_canonical": "025ecc3d2f64a5f731061f9380cdfbb258c0328d155bad8f23bc2bf2e7547de2",
    ...
    FrozenWorkload(
        ...
        "tools/benchmarks/merlo/benchmarks/productive_performance/ndjson/workload.ndjson", 548337,
        ...
        "real CLI NDJSON report with one process and identical arguments",
        {
            ...
            "merlo_canonical": "e28561532758805cbaabd758d56a78c306144ea6ec5c9553c1f3fccb36c7e952",
