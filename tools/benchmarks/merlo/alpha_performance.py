...
FROZEN_WORKLOADS: tuple[FrozenWorkload, ...] = (
    FrozenWorkload(
        ...
        "parse numeric columns and sum each row into one deterministic digest",
        {
            ...
            "merlo_canonical": "64b05b8d5e8654a435816399bfff687bfbff743c3d4bb2ba23ea51a2110e9a28",
    ...
    FrozenWorkload(
        ...
        "scan UTF-8 Text and Bytes while aggregating collection counts",
        {
            ...
            "merlo_canonical": "d74e36f0d575bbd93457129f62a3d7467fa0e0649edaf21c53f83577073b2244",
    ...
    FrozenWorkload(
        ...
        "real CLI NDJSON report with one process and identical arguments",
        {
            ...
            "merlo_canonical": "56a1d27782fbf4b4d7ba34f2d88e809a7c786662ccc172ab27b0d6173295f6e4",
