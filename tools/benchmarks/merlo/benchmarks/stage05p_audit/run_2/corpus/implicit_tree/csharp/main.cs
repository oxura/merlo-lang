...
static class Program {
 ...
 static ulong Run(ulong n) { unchecked { ulong checksum=0; for(ulong i=0;i<n;i++){Node x=new(i*3+1,i*2+1,i*2+2);checksum^=x.Value*(x.Left+x.Right+1);} return checksum; } }
