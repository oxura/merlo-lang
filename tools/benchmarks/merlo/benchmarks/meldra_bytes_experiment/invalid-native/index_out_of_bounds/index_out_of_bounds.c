...
static uint64_t meldra_fn_main(uint64_t meldra_n_1, uint64_t meldra_index_2);

static uint64_t meldra_fn_main(uint64_t meldra_n_1, uint64_t meldra_index_2) {
meldra_bb1_entry: ;
    /* bytes-invalid/index_out_of_bounds.meldra:2:19 i1 */
    ...
    /* bytes-invalid/index_out_of_bounds.meldra:3:4 i2 */
    uint64_t meldra_v_4 = meldra_v_3.length;
    /* bytes-invalid/index_out_of_bounds.meldra:3:4 i3 */
    ++meldra_bounds_checks;
    if (meldra_index_2 >= meldra_v_4) meldra_panic_bytes_bounds(meldra_index_2, meldra_v_4);
    /* bytes-invalid/index_out_of_bounds.meldra:3:4 i4 */
    uint64_t meldra_v_5 = (uint64_t)meldra_v_3.data[meldra_index_2];
    /* bytes-invalid/index_out_of_bounds.meldra:3:4 i5 */
