...
TASK_ID = 'm06-interface-call'
CASES = [('M|r9', {'request_id': 'r9', 'status': 'ok'}), ('M|r9x', {'request_id': 'r9x', 'status': 'ok'}), ('M|request-42', {'request_id': 'request-42', 'status': 'ok'})]
UNTOUCHED = [('L|legacy-7', {'request_id': 'missing', 'status': 'ok'})]
INPUT_ENCODING = 'raw'
