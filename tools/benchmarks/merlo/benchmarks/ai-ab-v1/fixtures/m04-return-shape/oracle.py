...
TASK_ID = 'm04-return-shape'
CASES = [('op=migrate|value=4|error=none', {'ok': True, 'value': 4}), ('op=migrate|value=9|error=none', {'ok': True, 'value': 9}), ('op=migrate|value=0|error=none', {'ok': True, 'value': 0})]
UNTOUCHED = [('op=legacy|value=11|error=none', {'ok': False, 'error': None})]
INPUT_ENCODING = 'raw'
