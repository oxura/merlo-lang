...
TASK_ID = 'm01-rename-field'
CASES = [('op=migrate|id=7|display_name=Ada', {'id': 7, 'label': 'Ada'}), ('op=migrate|id=42|display_name=Grace', {'id': 42, 'label': 'Grace'}), ('op=migrate|id=100|display_name=Lin', {'id': 100, 'label': 'Lin'})]
UNTOUCHED = [('op=legacy|id=9|display_name=Bea', {'id': 9, 'display_name': 'Bea'})]
INPUT_ENCODING = 'raw'
