...
static uint64_t meldra_fn_main(uint64_t meldra_ascii_1, uint64_t meldra_scalar_2);

static uint64_t meldra_fn_main(uint64_t meldra_ascii_1, uint64_t meldra_scalar_2) {
meldra_bb1_entry: ;
    /* ascii_and_scalar.meldra:2:15 i1 */
    if (meldra_ascii_1 > UINT64_C(127)) meldra_panic_ascii(meldra_ascii_1);
    meldra_text meldra_v_3 = meldra_text_from_scalar(meldra_ascii_1);
    /* ascii_and_scalar.meldra:3:16 i2 */
    meldra_text meldra_v_4 = meldra_text_from_scalar(meldra_scalar_2);
    /* ascii_and_scalar.meldra:4:8 i3 */
    uint64_t meldra_v_5 = meldra_v_3.length;
    /* ascii_and_scalar.meldra:4:28 i4 */
    uint64_t meldra_v_6 = meldra_v_4.length;
    /* ascii_and_scalar.meldra:4:8 i5 */
    uint64_t meldra_v_7 = meldra_v_5 + meldra_v_6;
    /* ascii_and_scalar.meldra:4:1 i6 */
    if (!meldra_v_3.live) meldra_panic_text_double_drop();
    ...
    /* ascii_and_scalar.meldra:4:1 i7 */
    if (!meldra_v_4.live) meldra_panic_text_double_drop();
