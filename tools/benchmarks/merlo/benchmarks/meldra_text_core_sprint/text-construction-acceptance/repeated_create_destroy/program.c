...
static uint64_t meldra_fn_main(uint64_t meldra_scalar_1, uint64_t meldra_repetitions_2) {
meldra_bb1_entry: ;
    /* repeated_create_destroy.meldra:2:20 i1 */
    uint64_t meldra_v_3 = UINT64_C(0);
    /* repeated_create_destroy.meldra:2:1 i2 */
    uint64_t meldra_v_4;
    /* repeated_create_destroy.meldra:2:1 i3 */
    meldra_v_4 = meldra_v_3;
    /* repeated_create_destroy.meldra:3:21 i4 */
    uint64_t meldra_v_5 = UINT64_C(0);
    /* repeated_create_destroy.meldra:3:1 i5 */
    uint64_t meldra_v_6;
    /* repeated_create_destroy.meldra:3:1 i6 */
    meldra_v_6 = meldra_v_5;
    goto meldra_bb2_while_header;
meldra_bb2_while_header: ;
    /* repeated_create_destroy.meldra:4:7 i7 */
    uint64_t meldra_v_7 = meldra_v_6;
    /* repeated_create_destroy.meldra:4:7 i8 */
...
meldra_bb3_while_body: ;
    /* repeated_create_destroy.meldra:5:15 i9 */
    meldra_text meldra_v_9 = meldra_text_from_scalar(meldra_scalar_1);
    /* repeated_create_destroy.meldra:6:19 i10 */
    meldra_text_view meldra_v_10 = { meldra_v_9.data, meldra_v_9.length };
    /* repeated_create_destroy.meldra:7:13 i11 */
    uint64_t meldra_v_11 = meldra_v_4;
    /* repeated_create_destroy.meldra:7:24 i12 */
    uint64_t meldra_v_12 = meldra_v_10.length;
    /* repeated_create_destroy.meldra:7:13 i13 */
    uint64_t meldra_v_13 = meldra_v_11 + meldra_v_12;
    /* repeated_create_destroy.meldra:7:43 i14 */
    uint64_t meldra_v_14 = UINT64_C(0);
    uint64_t meldra_scalar_index_i14 = UINT64_C(0);
    while (meldra_scalar_index_i14 < meldra_v_10.length) {
        meldra_scalar_index_i14 += meldra_utf8_scalar_width(meldra_v_10.data, meldra_v_10.length, meldra_scalar_index_i14);
        ++meldra_v_14;
    }
    /* repeated_create_destroy.meldra:7:13 i15 */
    uint64_t meldra_v_15 = meldra_v_13 + meldra_v_14;
    /* repeated_create_destroy.meldra:7:2 i16 */
    meldra_v_4 = meldra_v_15;
    /* repeated_create_destroy.meldra:7:2 i17 */
    /* TextView borrow_end: text_view:main:view:6:19 owner=main.text */
    /* repeated_create_destroy.meldra:8:14 i18 */
    uint64_t meldra_v_16 = meldra_v_6;
    /* repeated_create_destroy.meldra:8:26 i19 */
    uint64_t meldra_v_17 = UINT64_C(1);
    /* repeated_create_destroy.meldra:8:14 i20 */
    uint64_t meldra_v_18 = meldra_v_16 + meldra_v_17;
    /* repeated_create_destroy.meldra:8:2 i21 */
    meldra_v_6 = meldra_v_18;
    /* repeated_create_destroy.meldra:4:1 i22 */
    if (!meldra_v_9.live) meldra_panic_text_double_drop();
    if (meldra_v_9.data != NULL) { free(meldra_v_9.data); ++meldra_heap_frees; }
    meldra_v_9.data = NULL;
    meldra_v_9.length = 0;
    meldra_v_9.capacity = 0;
    meldra_v_9.live = false;
    goto meldra_bb2_while_header;
meldra_bb4_while_exit: ;
    /* repeated_create_destroy.meldra:9:8 i23 */
    uint64_t meldra_v_19 = meldra_v_4;
    return meldra_v_19;
}
