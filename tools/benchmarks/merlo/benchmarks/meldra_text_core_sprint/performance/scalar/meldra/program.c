...
static uint64_t meldra_fn_main(uint64_t meldra_scalar_1, uint64_t meldra_repetitions_2) {
meldra_bb1_entry: ;
    /* scalar-benchmark.meldra:2:20 i1 */
    uint64_t meldra_v_3 = UINT64_C(0);
    /* scalar-benchmark.meldra:2:1 i2 */
    uint64_t meldra_v_4;
    /* scalar-benchmark.meldra:2:1 i3 */
    meldra_v_4 = meldra_v_3;
    /* scalar-benchmark.meldra:3:21 i4 */
    uint64_t meldra_v_5 = UINT64_C(0);
    /* scalar-benchmark.meldra:3:1 i5 */
    uint64_t meldra_v_6;
    /* scalar-benchmark.meldra:3:1 i6 */
    meldra_v_6 = meldra_v_5;
    goto meldra_bb2_while_header;
meldra_bb2_while_header: ;
    /* scalar-benchmark.meldra:4:7 i7 */
    uint64_t meldra_v_7 = meldra_v_6;
    /* scalar-benchmark.meldra:4:7 i8 */
...
meldra_bb4_while_exit: ;
    /* scalar-benchmark.meldra:9:8 i23 */
