...
static uint64_t meldra_fn_main(uint64_t meldra_scalar_1, uint64_t meldra_repetitions_2) {
meldra_bb1_entry: ;
    /* text-builder-loop.meldra:2:20 i1 */
    uint64_t meldra_v_3 = UINT64_C(0);
    /* text-builder-loop.meldra:2:1 i2 */
    uint64_t meldra_v_4;
    /* text-builder-loop.meldra:2:1 i3 */
    meldra_v_4 = meldra_v_3;
    /* text-builder-loop.meldra:3:21 i4 */
    uint64_t meldra_v_5 = UINT64_C(0);
    /* text-builder-loop.meldra:3:1 i5 */
    uint64_t meldra_v_6;
    /* text-builder-loop.meldra:3:1 i6 */
    meldra_v_6 = meldra_v_5;
    goto meldra_bb2_while_header;
meldra_bb2_while_header: ;
    /* text-builder-loop.meldra:4:7 i7 */
    uint64_t meldra_v_7 = meldra_v_6;
    /* text-builder-loop.meldra:4:7 i8 */
...
meldra_bb3_while_body: ;
    /* text-builder-loop.meldra:5:25 i9 */
    uint64_t meldra_v_9 = UINT64_C(0);
    /* text-builder-loop.meldra:5:25 i10 */
    if (meldra_v_9 > UINT64_C(9223372036854775807)) meldra_panic_text_builder_allocation_size_overflow();
    meldra_bytes_builder meldra_v_10 = { NULL, UINT64_C(0), meldra_v_9, UINT64_C(0), UINT8_C(1) };
    if (meldra_v_9 > 0) {
        meldra_v_10.data = (uint8_t *)malloc((size_t)meldra_v_9);
        if (meldra_v_10.data == NULL) meldra_panic_alloc();
        ++meldra_heap_allocations;
        meldra_allocated_bytes += meldra_v_9;
    }
    /* text-builder-loop.meldra:6:2 i11 */
    ...
    uint64_t meldra_v_11 = meldra_scalar_1 <= UINT64_C(0x7F) ? UINT64_C(1) : (meldra_scalar_1 <= UINT64_C(0x7FF) ? UINT64_C(2) : (meldra_scalar_1 <= UINT64_C(0xFFFF) ? UINT64_C(3) : UINT64_C(4)));
    /* text-builder-loop.meldra:6:2 i12 */
    meldra_text_builder_required_append_bytes += meldra_v_11;
    /* text-builder-loop.meldra:6:2 i13 */
    if (meldra_v_10.state != UINT8_C(1)) meldra_panic_builder_state();
    if (meldra_v_10.active_views != 0) meldra_panic_builder_active_view();
    if (meldra_v_11 > UINT64_MAX - meldra_v_10.length) meldra_panic_text_builder_length_overflow();
    uint64_t meldra_builder_required_i13 = meldra_v_10.length + meldra_v_11;
    if (meldra_builder_required_i13 > meldra_v_10.capacity) {
        uint64_t meldra_builder_capacity_i13;
        if (meldra_v_10.capacity == 0) meldra_builder_capacity_i13 = meldra_builder_required_i13 > UINT64_C(8) ? meldra_builder_required_i13 : UINT64_C(8);
        else {
            if (meldra_v_10.capacity > UINT64_MAX / UINT64_C(2)) meldra_panic_text_builder_capacity_overflow();
            uint64_t meldra_builder_doubled_i13 = meldra_v_10.capacity * UINT64_C(2);
            meldra_builder_capacity_i13 = meldra_builder_required_i13 > meldra_builder_doubled_i13 ? meldra_builder_required_i13 : meldra_builder_doubled_i13;
        }
        if (meldra_builder_capacity_i13 > UINT64_C(9223372036854775807)) meldra_panic_text_builder_allocation_size_overflow();
        uint8_t *meldra_builder_storage_i13 = (uint8_t *)malloc((size_t)meldra_builder_capacity_i13);
        if (meldra_builder_storage_i13 == NULL) meldra_panic_alloc();
        ++meldra_heap_allocations;
        meldra_allocated_bytes += meldra_builder_capacity_i13;
        if (meldra_v_10.data != NULL) {
            if (meldra_v_10.length != 0) memcpy(meldra_builder_storage_i13, meldra_v_10.data, (size_t)meldra_v_10.length);
            meldra_builder_growth_copied_bytes += meldra_v_10.length;
            free(meldra_v_10.data);
            ++meldra_heap_frees;
            ++meldra_builder_reallocations;
        }
        meldra_v_10.data = meldra_builder_storage_i13;
        meldra_v_10.capacity = meldra_builder_capacity_i13;
    }
    /* text-builder-loop.meldra:6:2 i14 */
    /* conditional allocation event: required_exceeds_capacity */
    /* text-builder-loop.meldra:6:2 i15 */
    /* conditional payload_copy event: required_exceeds_capacity */
    /* text-builder-loop.meldra:6:2 i16 */
    /* conditional free event: required_exceeds_capacity */
    /* text-builder-loop.meldra:6:2 i17 */
    if (meldra_v_10.state != UINT8_C(1)) meldra_panic_builder_state();
    if (meldra_v_10.active_views != 0) meldra_panic_builder_active_view();
    if (meldra_scalar_1 > UINT64_C(0x10FFFF) || (meldra_scalar_1 >= UINT64_C(0xD800) && meldra_scalar_1 <= UINT64_C(0xDFFF))) meldra_panic_text_builder_scalar(meldra_scalar_1);
    if (meldra_v_11 > meldra_v_10.capacity - meldra_v_10.length) meldra_panic_builder_capacity_invariant();
    uint8_t *meldra_text_builder_out_i17 = meldra_v_10.data + meldra_v_10.length;
    if (meldra_v_11 == UINT64_C(1)) meldra_text_builder_out_i17[0] = (uint8_t)meldra_scalar_1;
    else if (meldra_v_11 == UINT64_C(2)) { meldra_text_builder_out_i17[0] = (uint8_t)(UINT64_C(0xC0) | (meldra_scalar_1 >> 6)); meldra_text_builder_out_i17[1] = (uint8_t)(UINT64_C(0x80) | (meldra_scalar_1 & UINT64_C(0x3F))); }
    else if (meldra_v_11 == UINT64_C(3)) { meldra_text_builder_out_i17[0] = (uint8_t)(UINT64_C(0xE0) | (meldra_scalar_1 >> 12)); meldra_text_builder_out_i17[1] = (uint8_t)(UINT64_C(0x80) | ((meldra_scalar_1 >> 6) & UINT64_C(0x3F))); meldra_text_builder_out_i17[2] = (uint8_t)(UINT64_C(0x80) | (meldra_scalar_1 & UINT64_C(0x3F))); }
    else { meldra_text_builder_out_i17[0] = (uint8_t)(UINT64_C(0xF0) | (meldra_scalar_1 >> 18)); meldra_text_builder_out_i17[1] = (uint8_t)(UINT64_C(0x80) | ((meldra_scalar_1 >> 12) & UINT64_C(0x3F))); meldra_text_builder_out_i17[2] = (uint8_t)(UINT64_C(0x80) | ((meldra_scalar_1 >> 6) & UINT64_C(0x3F))); meldra_text_builder_out_i17[3] = (uint8_t)(UINT64_C(0x80) | (meldra_scalar_1 & UINT64_C(0x3F))); }
    meldra_v_10.length += meldra_v_11;
    /* text-builder-loop.meldra:7:13 i18 */
    uint64_t meldra_v_12 = meldra_v_4;
    /* text-builder-loop.meldra:7:24 i19 */
    if (meldra_v_10.state != UINT8_C(1)) meldra_panic_builder_state();
    uint64_t meldra_v_13 = meldra_v_10.length;
    /* text-builder-loop.meldra:7:13 i20 */
    uint64_t meldra_v_14 = meldra_v_12 + meldra_v_13;
    /* text-builder-loop.meldra:7:2 i21 */
    meldra_v_4 = meldra_v_14;
    /* text-builder-loop.meldra:8:14 i22 */
    uint64_t meldra_v_15 = meldra_v_6;
    /* text-builder-loop.meldra:8:26 i23 */
    uint64_t meldra_v_16 = UINT64_C(1);
    /* text-builder-loop.meldra:8:14 i24 */
    uint64_t meldra_v_17 = meldra_v_15 + meldra_v_16;
    /* text-builder-loop.meldra:8:2 i25 */
    meldra_v_6 = meldra_v_17;
    /* text-builder-loop.meldra:4:1 i26 */
    if (meldra_v_10.state != UINT8_C(1)) meldra_panic_builder_state();
    if (meldra_v_10.active_views != 0) meldra_panic_builder_active_view();
    if (meldra_v_10.data != NULL) { free(meldra_v_10.data); ++meldra_heap_frees; }
    meldra_v_10.data = NULL;
    meldra_v_10.length = 0;
    meldra_v_10.capacity = 0;
    meldra_v_10.active_views = 0;
    meldra_v_10.state = UINT8_C(4);
    goto meldra_bb2_while_header;
meldra_bb4_while_exit: ;
    /* text-builder-loop.meldra:9:8 i27 */
