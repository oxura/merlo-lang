...
static meldra_bytes_builder meldra_fn_append_scalar(meldra_bytes_builder meldra_builder_1, uint64_t meldra_scalar_2);
static meldra_text meldra_fn_finish_message(meldra_bytes_builder meldra_builder_1, uint64_t meldra_suffix_2);
static uint64_t meldra_fn_main(uint64_t meldra_scalar_1);

static meldra_bytes_builder meldra_fn_append_scalar(meldra_bytes_builder meldra_builder_1, uint64_t meldra_scalar_2) {
meldra_bb1_entry: ;
    /* text-builder-calls.meldra:2:1 i1 */
    if (meldra_scalar_2 > UINT64_C(0x10FFFF) || (meldra_scalar_2 >= UINT64_C(0xD800) && meldra_scalar_2 <= UINT64_C(0xDFFF))) meldra_panic_text_builder_scalar(meldra_scalar_2);
    uint64_t meldra_v_3 = meldra_scalar_2 <= UINT64_C(0x7F) ? UINT64_C(1) : (meldra_scalar_2 <= UINT64_C(0x7FF) ? UINT64_C(2) : (meldra_scalar_2 <= UINT64_C(0xFFFF) ? UINT64_C(3) : UINT64_C(4)));
    /* text-builder-calls.meldra:2:1 i2 */
    meldra_text_builder_required_append_bytes += meldra_v_3;
    /* text-builder-calls.meldra:2:1 i3 */
    ...
    if (meldra_v_3 > UINT64_MAX - meldra_builder_1.length) meldra_panic_text_builder_length_overflow();
    uint64_t meldra_builder_required_i3 = meldra_builder_1.length + meldra_v_3;
    if (meldra_builder_required_i3 > meldra_builder_1.capacity) {
        uint64_t meldra_builder_capacity_i3;
        if (meldra_builder_1.capacity == 0) meldra_builder_capacity_i3 = meldra_builder_required_i3 > UINT64_C(8) ? meldra_builder_required_i3 : UINT64_C(8);
        else {
            if (meldra_builder_1.capacity > UINT64_MAX / UINT64_C(2)) meldra_panic_text_builder_capacity_overflow();
            uint64_t meldra_builder_doubled_i3 = meldra_builder_1.capacity * UINT64_C(2);
            meldra_builder_capacity_i3 = meldra_builder_required_i3 > meldra_builder_doubled_i3 ? meldra_builder_required_i3 : meldra_builder_doubled_i3;
        }
        if (meldra_builder_capacity_i3 > UINT64_C(9223372036854775807)) meldra_panic_text_builder_allocation_size_overflow();
        uint8_t *meldra_builder_storage_i3 = (uint8_t *)malloc((size_t)meldra_builder_capacity_i3);
        if (meldra_builder_storage_i3 == NULL) meldra_panic_alloc();
        ++meldra_heap_allocations;
        meldra_allocated_bytes += meldra_builder_capacity_i3;
        if (meldra_builder_1.data != NULL) {
            if (meldra_builder_1.length != 0) memcpy(meldra_builder_storage_i3, meldra_builder_1.data, (size_t)meldra_builder_1.length);
            meldra_builder_growth_copied_bytes += meldra_builder_1.length;
            free(meldra_builder_1.data);
            ++meldra_heap_frees;
            ++meldra_builder_reallocations;
        }
        meldra_builder_1.data = meldra_builder_storage_i3;
        meldra_builder_1.capacity = meldra_builder_capacity_i3;
    }
    /* text-builder-calls.meldra:2:1 i4 */
    /* conditional allocation event: required_exceeds_capacity */
    /* text-builder-calls.meldra:2:1 i5 */
    /* conditional payload_copy event: required_exceeds_capacity */
    /* text-builder-calls.meldra:2:1 i6 */
    /* conditional free event: required_exceeds_capacity */
    /* text-builder-calls.meldra:2:1 i7 */
    if (meldra_builder_1.state != UINT8_C(1)) meldra_panic_builder_state();
    if (meldra_builder_1.active_views != 0) meldra_panic_builder_active_view();
    if (meldra_scalar_2 > UINT64_C(0x10FFFF) || (meldra_scalar_2 >= UINT64_C(0xD800) && meldra_scalar_2 <= UINT64_C(0xDFFF))) meldra_panic_text_builder_scalar(meldra_scalar_2);
    if (meldra_v_3 > meldra_builder_1.capacity - meldra_builder_1.length) meldra_panic_builder_capacity_invariant();
    uint8_t *meldra_text_builder_out_i7 = meldra_builder_1.data + meldra_builder_1.length;
    if (meldra_v_3 == UINT64_C(1)) meldra_text_builder_out_i7[0] = (uint8_t)meldra_scalar_2;
    else if (meldra_v_3 == UINT64_C(2)) { meldra_text_builder_out_i7[0] = (uint8_t)(UINT64_C(0xC0) | (meldra_scalar_2 >> 6)); meldra_text_builder_out_i7[1] = (uint8_t)(UINT64_C(0x80) | (meldra_scalar_2 & UINT64_C(0x3F))); }
    else if (meldra_v_3 == UINT64_C(3)) { meldra_text_builder_out_i7[0] = (uint8_t)(UINT64_C(0xE0) | (meldra_scalar_2 >> 12)); meldra_text_builder_out_i7[1] = (uint8_t)(UINT64_C(0x80) | ((meldra_scalar_2 >> 6) & UINT64_C(0x3F))); meldra_text_builder_out_i7[2] = (uint8_t)(UINT64_C(0x80) | (meldra_scalar_2 & UINT64_C(0x3F))); }
    else { meldra_text_builder_out_i7[0] = (uint8_t)(UINT64_C(0xF0) | (meldra_scalar_2 >> 18)); meldra_text_builder_out_i7[1] = (uint8_t)(UINT64_C(0x80) | ((meldra_scalar_2 >> 12) & UINT64_C(0x3F))); meldra_text_builder_out_i7[2] = (uint8_t)(UINT64_C(0x80) | ((meldra_scalar_2 >> 6) & UINT64_C(0x3F))); meldra_text_builder_out_i7[3] = (uint8_t)(UINT64_C(0x80) | (meldra_scalar_2 & UINT64_C(0x3F))); }
    meldra_builder_1.length += meldra_v_3;
    return meldra_builder_1;
}

static meldra_text meldra_fn_finish_message(meldra_bytes_builder meldra_builder_1, uint64_t meldra_suffix_2) {
meldra_bb1_entry: ;
    /* text-builder-calls.meldra:6:1 i1 */
    uint64_t meldra_v_3 = UINT64_C(1);
    /* text-builder-calls.meldra:6:1 i2 */
    meldra_text_builder_required_append_bytes += meldra_v_3;
    /* text-builder-calls.meldra:6:1 i3 */
    if (meldra_builder_1.state != UINT8_C(1)) meldra_panic_builder_state();
    if (meldra_builder_1.active_views != 0) meldra_panic_builder_active_view();
    if (meldra_v_3 > UINT64_MAX - meldra_builder_1.length) meldra_panic_text_builder_length_overflow();
    uint64_t meldra_builder_required_i3 = meldra_builder_1.length + meldra_v_3;
    ...
    /* text-builder-calls.meldra:6:1 i4 */
    /* conditional allocation event: required_exceeds_capacity */
    /* text-builder-calls.meldra:6:1 i5 */
    /* conditional payload_copy event: required_exceeds_capacity */
    /* text-builder-calls.meldra:6:1 i6 */
    /* conditional free event: required_exceeds_capacity */
    /* text-builder-calls.meldra:6:1 i7 */
    if (meldra_builder_1.state != UINT8_C(1)) meldra_panic_builder_state();
    if (meldra_builder_1.active_views != 0) meldra_panic_builder_active_view();
    if (meldra_suffix_2 > UINT64_C(0x7F)) meldra_panic_text_builder_ascii(meldra_suffix_2);
    if (meldra_builder_1.length >= meldra_builder_1.capacity) meldra_panic_builder_capacity_invariant();
    meldra_builder_1.data[meldra_builder_1.length++] = (uint8_t)meldra_suffix_2;
    /* text-builder-calls.meldra:7:8 i8 */
    if (meldra_builder_1.state != UINT8_C(1)) meldra_panic_builder_state();
    if (meldra_builder_1.active_views != 0) meldra_panic_builder_active_view();
    meldra_text meldra_v_4 = { meldra_builder_1.data, meldra_builder_1.length, meldra_builder_1.capacity, true };
...
static uint64_t meldra_fn_main(uint64_t meldra_scalar_1) {
meldra_bb1_entry: ;
    /* text-builder-calls.meldra:10:54 i1 */
    uint64_t meldra_v_2 = UINT64_C(8);
    /* text-builder-calls.meldra:10:22 i2 */
    ...
    /* text-builder-calls.meldra:11:37 i3 */
    meldra_bytes_builder meldra_v_4 = meldra_v_3;
    meldra_v_3.data = NULL;
    meldra_v_3.length = 0;
    meldra_v_3.capacity = 0;
    meldra_v_3.active_views = 0;
    meldra_v_3.state = UINT8_C(2);
    /* text-builder-calls.meldra:11:23 i4 */
    meldra_bytes_builder meldra_v_5 = meldra_fn_append_scalar(meldra_v_4, meldra_scalar_1);
    /* text-builder-calls.meldra:12:29 i5 */
    meldra_bytes_builder meldra_v_6 = meldra_v_5;
    meldra_v_5.data = NULL;
    meldra_v_5.length = 0;
    meldra_v_5.capacity = 0;
    meldra_v_5.active_views = 0;
    meldra_v_5.state = UINT8_C(2);
    /* text-builder-calls.meldra:12:43 i6 */
    uint64_t meldra_v_7 = UINT64_C(33);
    /* text-builder-calls.meldra:12:14 i7 */
    meldra_text meldra_v_8 = meldra_fn_finish_message(meldra_v_6, meldra_v_7);
    /* text-builder-calls.meldra:13:8 i8 */
    uint64_t meldra_v_9 = meldra_v_8.length;
    /* text-builder-calls.meldra:13:1 i9 */
    if (!meldra_v_8.live) meldra_panic_text_double_drop();
    if (meldra_v_8.data != NULL) { free(meldra_v_8.data); ++meldra_heap_frees; }
    meldra_v_8.data = NULL;
    meldra_v_8.length = 0;
    meldra_v_8.capacity = 0;
    meldra_v_8.live = false;
    return meldra_v_9;
}
