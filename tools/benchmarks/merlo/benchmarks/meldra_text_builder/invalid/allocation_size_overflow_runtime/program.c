...
meldra_bb1_entry: ;
    /* main.meldra:2:24 i1 */
    if (meldra_value_1 > UINT64_C(9223372036854775807)) meldra_panic_text_builder_allocation_size_overflow();
    meldra_bytes_builder meldra_v_2 = { NULL, UINT64_C(0), meldra_value_1, UINT64_C(0), UINT8_C(1) };
    if (meldra_value_1 > 0) {
        meldra_v_2.data = (uint8_t *)malloc((size_t)meldra_value_1);
        if (meldra_v_2.data == NULL) meldra_panic_alloc();
        ++meldra_heap_allocations;
        meldra_allocated_bytes += meldra_value_1;
    }
    /* main.meldra:3:8 i2 */
    if (meldra_v_2.state != UINT8_C(1)) meldra_panic_builder_state();
    uint64_t meldra_v_3 = meldra_v_2.length;
    /* main.meldra:3:1 i3 */
    if (meldra_v_2.state != UINT8_C(1)) meldra_panic_builder_state();
