...
meldra_bb1_entry: ;
    ...
    /* main.meldra:3:1 i3 */
    uint64_t meldra_v_4 = UINT64_C(1);
    /* main.meldra:3:1 i4 */
    ...
    if (meldra_v_3.state != UINT8_C(1)) meldra_panic_builder_state();
    if (meldra_v_3.active_views != 0) meldra_panic_builder_active_view();
    if (meldra_value_1 > UINT64_C(0x7F)) meldra_panic_text_builder_ascii(meldra_value_1);
    if (meldra_v_3.length >= meldra_v_3.capacity) meldra_panic_builder_capacity_invariant();
    meldra_v_3.data[meldra_v_3.length++] = (uint8_t)meldra_value_1;
