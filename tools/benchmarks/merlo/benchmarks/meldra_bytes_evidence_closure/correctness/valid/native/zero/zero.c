...
static uint64_t meldra_fn_main(uint64_t meldra_n_1, uint64_t meldra_seed_2, uint64_t meldra_rounds_3, uint64_t meldra_slice_start_4, uint64_t meldra_slice_length_5) {
meldra_bb1_entry: ;
    /* bytes-closure/zero.meldra:2:19 i1 */
    ...
    /* bytes-closure/zero.meldra:3:22 i2 */
    ...
    meldra_bytes_view meldra_v_7 = { meldra_v_6.data == NULL ? NULL : meldra_v_6.data + meldra_slice_start_4, meldra_slice_length_5 };
    /* bytes-closure/zero.meldra:4:4 i3 */
    uint64_t meldra_v_8 = meldra_seed_2 ^ meldra_rounds_3;
    /* bytes-closure/zero.meldra:4:20 i4 */
    uint64_t meldra_v_9 = meldra_v_6.length;
    /* bytes-closure/zero.meldra:4:4 i5 */
    uint64_t meldra_v_10 = meldra_v_8 ^ meldra_v_9;
    /* bytes-closure/zero.meldra:4:34 i6 */
    uint64_t meldra_v_11 = meldra_v_7.length;
    /* bytes-closure/zero.meldra:4:4 i7 */
    uint64_t meldra_v_12 = meldra_v_10 ^ meldra_v_11;
    /* bytes-closure/zero.meldra:4:4 i8 */
