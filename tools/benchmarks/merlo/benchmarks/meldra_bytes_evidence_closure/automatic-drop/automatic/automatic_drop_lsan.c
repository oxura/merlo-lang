...
meldra_bb1_entry: ;
    ...
    /* automatic_drop.meldra:3:10 i2 */
    uint64_t meldra_v_3 = UINT64_C(0);
    /* automatic_drop.meldra:3:15 i3 */
    uint64_t meldra_v_4 = UINT64_C(29);
    /* automatic_drop.meldra:3:4 i4 */
    uint64_t meldra_v_5 = meldra_v_2.length;
    /* automatic_drop.meldra:3:4 i5 */
    ++meldra_bounds_checks;
    if (meldra_v_3 >= meldra_v_5) meldra_panic_bytes_bounds(meldra_v_3, meldra_v_5);
    /* automatic_drop.meldra:3:4 i6 */
    meldra_v_2.data[meldra_v_3] = (uint8_t)(meldra_v_4 & UINT64_C(255));
    /* automatic_drop.meldra:4:10 i7 */
    uint64_t meldra_v_6 = UINT64_C(0);
    /* automatic_drop.meldra:4:4 i8 */
    uint64_t meldra_v_7 = meldra_v_2.length;
    /* automatic_drop.meldra:4:4 i9 */
    ++meldra_bounds_checks;
    if (meldra_v_6 >= meldra_v_7) meldra_panic_bytes_bounds(meldra_v_6, meldra_v_7);
    /* automatic_drop.meldra:4:4 i10 */
    uint64_t meldra_v_8 = (uint64_t)meldra_v_2.data[meldra_v_6];
    /* automatic_drop.meldra:4:15 i11 */
    uint64_t meldra_v_9 = meldra_v_2.length;
    /* automatic_drop.meldra:4:4 i12 */
    uint64_t meldra_v_10 = meldra_v_8 + meldra_v_9;
    /* automatic_drop.meldra:4:4 i13 */
