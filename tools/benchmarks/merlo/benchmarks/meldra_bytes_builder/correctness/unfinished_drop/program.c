...
static uint64_t meldra_fn_main(uint64_t meldra_n_1, uint64_t meldra_seed_2) {
meldra_bb1_entry: ;
    /* tools/benchmarks/merlo/benchmarks/meldra_bytes_builder/correctness/unfinished_drop.meldra:2:28 i1 */
    if (meldra_n_1 > UINT64_C(9223372036854775807)) meldra_panic_builder_allocation_size_overflow();
    meldra_bytes_builder meldra_v_3 = { NULL, UINT64_C(0), meldra_n_1, UINT64_C(0), UINT8_C(1) };
    if (meldra_n_1 > 0) {
    ...
    /* tools/benchmarks/merlo/benchmarks/meldra_bytes_builder/correctness/unfinished_drop.meldra:3:11 i2 */
    uint64_t meldra_v_4 = UINT64_C(0);
    /* tools/benchmarks/merlo/benchmarks/meldra_bytes_builder/correctness/unfinished_drop.meldra:3:7 i3 */
    bool meldra_v_5 = meldra_n_1 > meldra_v_4;
    if (meldra_v_5) goto meldra_bb2_if_then; else goto meldra_bb3_if_else;
meldra_bb2_if_then: ;
    /* tools/benchmarks/merlo/benchmarks/meldra_bytes_builder/correctness/unfinished_drop.meldra:4:28 i4 */
    uint64_t meldra_v_6 = UINT64_C(255);
    /* tools/benchmarks/merlo/benchmarks/meldra_bytes_builder/correctness/unfinished_drop.meldra:4:21 i5 */
    uint64_t meldra_v_7 = meldra_seed_2 & meldra_v_6;
    /* tools/benchmarks/merlo/benchmarks/meldra_bytes_builder/correctness/unfinished_drop.meldra:4:8 i6 */
    uint64_t meldra_v_8 = UINT64_C(1);
    /* tools/benchmarks/merlo/benchmarks/meldra_bytes_builder/correctness/unfinished_drop.meldra:4:8 i7 */
    if (meldra_v_3.state != UINT8_C(1)) meldra_panic_builder_state();
    if (meldra_v_3.active_views != 0) meldra_panic_builder_active_view();
    if (meldra_v_8 > UINT64_MAX - meldra_v_3.length) meldra_panic_builder_length_overflow();
    uint64_t meldra_builder_required_i7 = meldra_v_3.length + meldra_v_8;
    if (meldra_builder_required_i7 > meldra_v_3.capacity) {
        ...
        if (meldra_v_3.capacity == 0) meldra_builder_capacity_i7 = meldra_builder_required_i7 > UINT64_C(8) ? meldra_builder_required_i7 : UINT64_C(8);
            ...
            if (meldra_v_3.capacity > UINT64_MAX / UINT64_C(2)) meldra_panic_builder_capacity_overflow();
        ...
        if (meldra_builder_capacity_i7 > UINT64_C(9223372036854775807)) meldra_panic_builder_allocation_size_overflow();
    ...
    /* tools/benchmarks/merlo/benchmarks/meldra_bytes_builder/correctness/unfinished_drop.meldra:4:8 i8 */
    /* conditional allocation event: required_exceeds_capacity */
    /* tools/benchmarks/merlo/benchmarks/meldra_bytes_builder/correctness/unfinished_drop.meldra:4:8 i9 */
    /* conditional payload_copy event: required_exceeds_capacity */
    /* tools/benchmarks/merlo/benchmarks/meldra_bytes_builder/correctness/unfinished_drop.meldra:4:8 i10 */
    /* conditional free event: required_exceeds_capacity */
    /* tools/benchmarks/merlo/benchmarks/meldra_bytes_builder/correctness/unfinished_drop.meldra:4:8 i11 */
    if (meldra_v_3.state != UINT8_C(1)) meldra_panic_builder_state();
    if (meldra_v_3.active_views != 0) meldra_panic_builder_active_view();
    if (meldra_v_7 > UINT64_C(255)) meldra_panic_builder_byte(meldra_v_7);
...
meldra_bb3_if_else: ;
    goto meldra_bb4_if_join;
meldra_bb4_if_join: ;
    /* tools/benchmarks/merlo/benchmarks/meldra_bytes_builder/correctness/unfinished_drop.meldra:5:11 i12 */
    if (meldra_v_3.state != UINT8_C(1)) meldra_panic_builder_state();
    uint64_t meldra_v_9 = meldra_v_3.length;
    /* tools/benchmarks/merlo/benchmarks/meldra_bytes_builder/correctness/unfinished_drop.meldra:5:27 i13 */
    if (meldra_v_3.state != UINT8_C(1)) meldra_panic_builder_state();
    uint64_t meldra_v_10 = meldra_v_3.capacity;
    /* tools/benchmarks/merlo/benchmarks/meldra_bytes_builder/correctness/unfinished_drop.meldra:5:11 i14 */
    uint64_t meldra_v_11 = meldra_v_9 + meldra_v_10;
    /* tools/benchmarks/merlo/benchmarks/meldra_bytes_builder/correctness/unfinished_drop.meldra:5:4 i15 */
    if (meldra_v_3.state != UINT8_C(1)) meldra_panic_builder_state();
    if (meldra_v_3.active_views != 0) meldra_panic_builder_active_view();
