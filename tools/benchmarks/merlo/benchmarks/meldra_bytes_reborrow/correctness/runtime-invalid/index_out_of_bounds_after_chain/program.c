...
static uint64_t meldra_fn_leaf(meldra_bytes_view meldra_data_1);
static uint64_t meldra_fn_main(uint64_t meldra_n_1);
static uint64_t meldra_fn_outer(meldra_bytes_view meldra_data_1);

static uint64_t meldra_fn_leaf(meldra_bytes_view meldra_data_1) {
meldra_bb1_entry: ;
    /* main.meldra:2:11 i1 */
    uint64_t meldra_v_2 = meldra_data_1.length;
    return meldra_v_2;
}
...
meldra_bb1_entry: ;
    ...
    /* main.meldra:7:28 i3 */
    if (meldra_v_3 > meldra_v_2.length || meldra_n_1 > meldra_v_2.length - meldra_v_3) meldra_panic_bytes_slice(meldra_v_3, meldra_n_1, meldra_v_2.length);
    meldra_bytes_view meldra_v_4 = { meldra_v_2.data == NULL ? NULL : meldra_v_2.data + meldra_v_3, meldra_n_1 };
    /* main.meldra:7:22 i4 */
    /* borrow_argument: borrow_argument:main:7:22:outer:data root=main.owner */
    /* main.meldra:7:22 i5 */
    uint64_t meldra_v_5 = meldra_fn_outer(meldra_v_4);
    /* main.meldra:7:22 i6 */
    /* borrow_end: borrow_argument:main:7:22:outer:data root=main.owner */
    /* main.meldra:8:21 i7 */
    uint64_t meldra_v_6 = meldra_v_2.length;
    /* main.meldra:8:21 i8 */
    ++meldra_bounds_checks;
    if (meldra_n_1 >= meldra_v_6) meldra_panic_bytes_bounds(meldra_n_1, meldra_v_6);
    /* main.meldra:8:21 i9 */
    uint64_t meldra_v_7 = (uint64_t)meldra_v_2.data[meldra_n_1];
    /* main.meldra:8:11 i10 */
    uint64_t meldra_v_8 = meldra_v_5 + meldra_v_7;
    /* main.meldra:8:4 i11 */
...
meldra_bb1_entry: ;
    /* main.meldra:4:11 i1 */
    /* reborrow_argument: reborrow_argument:outer:4:11:leaf:data root=main.owner */
    /* main.meldra:4:11 i2 */
    uint64_t meldra_v_2 = meldra_fn_leaf(meldra_data_1);
    /* main.meldra:4:11 i3 */
    /* reborrow_end: reborrow_argument:outer:4:11:leaf:data root=main.owner */
    return meldra_v_2;
}
