...
from merlo.representation_runtime import evaluate_structured_hir, exercise_vec_box_runtime
from merlo.structured_hir_v2 import compile_structured_hir, compile_structured_hir_file
...
def _validate_correction(root: Path) -> dict[str, Any]:
    path = root / "research" / "archive" / "alpha1" / "benchmarks" / "merlo_evidence_correction_v1.json"
...
def run_general_representation_milestone(root: str | Path = ".") -> dict[str, Any]:
    ...
    artifact = root_path / "tools" / "benchmarks" / "merlo" / "benchmarks" / "general_representation"
    ...
    benchmark_path = (
        root_path / "tools" / "benchmarks" / "merlo" / "benchmarks" / "merlo_general_representation_benchmark.json"
    )
    ...
    architecture = {
        ...
        "c_backend": {
            **generated.to_dict(),
            "generated_source_path": "tools/benchmarks/merlo/benchmarks/general_representation/generated_json.c",
            "generated_source_sha256": _sha256(
                artifact / "generated_json.c"
            ),
            "native_binary_path": "tools/benchmarks/merlo/benchmarks/general_representation/merlo_json",
            "host_scope": "stdin/stdout, repeat parsing, and process exit only",
        },
        "representative_forms": {
            "structured_hir": "tools/benchmarks/merlo/benchmarks/general_representation/structured_hir_v2.json",
            "representation_ir": "tools/benchmarks/merlo/benchmarks/general_representation/representation_ir_v1.json",
            "performance_mir": "tools/benchmarks/merlo/benchmarks/general_representation/performance_mir.json",
            "optimized_mir": "tools/benchmarks/merlo/benchmarks/general_representation/performance_mir_optimized.json",
        },
    ...
    output = root_path / "tools" / "benchmarks" / "merlo" / "benchmarks" / "merlo_general_representation_core.json"
