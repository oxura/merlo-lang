...
from tools.benchmarks.merlo.productive_simplicity import extract_source_metrics
...
DEFAULT_CORPUS = Path(__file__).resolve().parents[3] / "research" / "archive" / "alpha1" / "benchmarks" / "alpha_simplicity" / "corpus.json"
