...
static uint64_t meldra_fn_leaf(meldra_bytes_view meldra_data_1, uint64_t meldra_state_2) {
meldra_bb1_entry: ;
    /* valid/owner_move_after.meldra:2:4 i1 */
    uint64_t meldra_v_3;
    /* valid/owner_move_after.meldra:2:4 i2 */
    meldra_v_3 = meldra_state_2;
    /* valid/owner_move_after.meldra:3:26 i3 */
    uint64_t meldra_v_4 = UINT64_C(0);
    /* valid/owner_move_after.meldra:3:29 i4 */
    uint64_t meldra_v_5 = meldra_data_1.length;
    /* valid/owner_move_after.meldra:3:4 i5 */
    uint64_t meldra_v_6;
    /* valid/owner_move_after.meldra:3:4 i6 */
    meldra_v_6 = meldra_v_4;
    goto meldra_bb2_for_header;
meldra_bb2_for_header: ;
    /* valid/owner_move_after.meldra:3:4 i7 */
    uint64_t meldra_v_7 = meldra_v_6;
    /* valid/owner_move_after.meldra:3:4 i8 */
    bool meldra_v_8 = meldra_v_7 < meldra_v_5;
    if (meldra_v_8) goto meldra_bb3_for_body; else goto meldra_bb4_for_exit;
meldra_bb3_for_body: ;
    /* valid/owner_move_after.meldra:4:20 i9 */
    uint64_t meldra_v_9 = meldra_v_3;
    /* valid/owner_move_after.meldra:4:37 i10 */
    uint64_t meldra_v_10 = meldra_v_6;
    /* valid/owner_move_after.meldra:4:32 i11 */
    uint64_t meldra_v_11 = meldra_data_1.length;
    /* valid/owner_move_after.meldra:4:32 i12 */
    ++meldra_bounds_checks;
    if (meldra_v_10 >= meldra_v_11) meldra_panic_bytes_bounds(meldra_v_10, meldra_v_11);
    /* valid/owner_move_after.meldra:4:32 i13 */
    uint64_t meldra_v_12 = (uint64_t)meldra_data_1.data[meldra_v_10];
    /* valid/owner_move_after.meldra:4:42 i14 */
    uint64_t meldra_v_13 = meldra_v_6;
    /* valid/owner_move_after.meldra:4:32 i15 */
    uint64_t meldra_v_14 = meldra_v_12 + meldra_v_13;
    /* valid/owner_move_after.meldra:4:46 i16 */
    uint64_t meldra_v_15 = UINT64_C(35);
    /* valid/owner_move_after.meldra:4:32 i17 */
    uint64_t meldra_v_16 = meldra_v_14 + meldra_v_15;
    /* valid/owner_move_after.meldra:4:20 i18 */
    uint64_t meldra_v_17 = meldra_v_9 ^ meldra_v_16;
    /* valid/owner_move_after.meldra:4:53 i19 */
    uint64_t meldra_v_18 = UINT64_C(1099511628211);
    /* valid/owner_move_after.meldra:4:19 i20 */
    uint64_t meldra_v_19 = meldra_v_17 * meldra_v_18;
    /* valid/owner_move_after.meldra:4:8 i21 */
    meldra_v_3 = meldra_v_19;
    /* valid/owner_move_after.meldra:3:4 i22 */
    uint64_t meldra_v_20 = meldra_v_6;
    /* valid/owner_move_after.meldra:3:4 i23 */
    uint64_t meldra_v_21 = UINT64_C(1);
    /* valid/owner_move_after.meldra:3:4 i24 */
    uint64_t meldra_v_22 = meldra_v_20 + meldra_v_21;
    /* valid/owner_move_after.meldra:3:4 i25 */
    meldra_v_6 = meldra_v_22;
    goto meldra_bb2_for_header;
meldra_bb4_for_exit: ;
    /* valid/owner_move_after.meldra:5:11 i26 */
...
static uint64_t meldra_fn_main(uint64_t meldra_n_1, uint64_t meldra_seed_2, uint64_t meldra_start_3, uint64_t meldra_length_4, bool meldra_flag_5) {
meldra_bb1_entry: ;
    /* valid/owner_move_after.meldra:14:19 i1 */
    ...
    /* valid/owner_move_after.meldra:15:26 i2 */
    uint64_t meldra_v_7 = UINT64_C(0);
    /* valid/owner_move_after.meldra:15:4 i3 */
    uint64_t meldra_v_8;
    /* valid/owner_move_after.meldra:15:4 i4 */
    meldra_v_8 = meldra_v_7;
    goto meldra_bb2_for_header;
meldra_bb2_for_header: ;
    /* valid/owner_move_after.meldra:15:4 i5 */
    uint64_t meldra_v_9 = meldra_v_8;
    /* valid/owner_move_after.meldra:15:4 i6 */
    bool meldra_v_10 = meldra_v_9 < meldra_n_1;
    if (meldra_v_10) goto meldra_bb3_for_body; else goto meldra_bb4_for_exit;
meldra_bb3_for_body: ;
    /* valid/owner_move_after.meldra:16:14 i7 */
    uint64_t meldra_v_11 = meldra_v_8;
    /* valid/owner_move_after.meldra:16:27 i8 */
    uint64_t meldra_v_12 = meldra_v_8;
    /* valid/owner_move_after.meldra:16:31 i9 */
    uint64_t meldra_v_13 = UINT64_C(17);
    /* valid/owner_move_after.meldra:16:27 i10 */
    uint64_t meldra_v_14 = meldra_v_12 * meldra_v_13;
    /* valid/owner_move_after.meldra:16:20 i11 */
    uint64_t meldra_v_15 = meldra_seed_2 + meldra_v_14;
    /* valid/owner_move_after.meldra:16:37 i12 */
    uint64_t meldra_v_16 = meldra_v_8;
    /* valid/owner_move_after.meldra:16:42 i13 */
    uint64_t meldra_v_17 = UINT64_C(3);
    /* valid/owner_move_after.meldra:16:37 i14 */
    uint64_t meldra_v_18 = meldra_u64_shift_right(meldra_v_16, meldra_v_17);
    /* valid/owner_move_after.meldra:16:20 i15 */
    uint64_t meldra_v_19 = meldra_v_15 + meldra_v_18;
    /* valid/owner_move_after.meldra:16:47 i16 */
    uint64_t meldra_v_20 = UINT64_C(35);
    /* valid/owner_move_after.meldra:16:20 i17 */
    uint64_t meldra_v_21 = meldra_v_19 + meldra_v_20;
    /* valid/owner_move_after.meldra:16:53 i18 */
    uint64_t meldra_v_22 = UINT64_C(255);
    /* valid/owner_move_after.meldra:16:19 i19 */
    uint64_t meldra_v_23 = meldra_v_21 & meldra_v_22;
    /* valid/owner_move_after.meldra:16:8 i20 */
    uint64_t meldra_v_24 = meldra_v_6.length;
    /* valid/owner_move_after.meldra:16:8 i21 */
    ++meldra_bounds_checks;
    if (meldra_v_11 >= meldra_v_24) meldra_panic_bytes_bounds(meldra_v_11, meldra_v_24);
    /* valid/owner_move_after.meldra:16:8 i22 */
    meldra_v_6.data[meldra_v_11] = (uint8_t)(meldra_v_23 & UINT64_C(255));
    /* valid/owner_move_after.meldra:15:4 i23 */
    uint64_t meldra_v_25 = meldra_v_8;
    /* valid/owner_move_after.meldra:15:4 i24 */
    uint64_t meldra_v_26 = UINT64_C(1);
    /* valid/owner_move_after.meldra:15:4 i25 */
    uint64_t meldra_v_27 = meldra_v_25 + meldra_v_26;
    /* valid/owner_move_after.meldra:15:4 i26 */
    meldra_v_8 = meldra_v_27;
    goto meldra_bb2_for_header;
meldra_bb4_for_exit: ;
    /* valid/owner_move_after.meldra:17:22 i27 */
    ...
    /* valid/owner_move_after.meldra:18:23 i28 */
    /* borrow_argument: borrow_argument:main:18:23:outer:data root=main.owner */
    /* valid/owner_move_after.meldra:18:23 i29 */
    uint64_t meldra_v_29 = meldra_fn_outer(meldra_v_28, meldra_seed_2);
    /* valid/owner_move_after.meldra:18:23 i30 */
    /* borrow_end: borrow_argument:main:18:23:outer:data root=main.owner */
    /* valid/owner_move_after.meldra:19:28 i31 */
    meldra_bytes meldra_v_30 = meldra_v_6;
    meldra_v_6.data = NULL;
    meldra_v_6.length = 0;
    meldra_v_6.capacity = 0;
    meldra_v_6.live = false;
    /* valid/owner_move_after.meldra:19:19 i32 */
    meldra_bytes meldra_v_31 = meldra_fn_transfer(meldra_v_30);
    /* valid/owner_move_after.meldra:20:22 i33 */
    uint64_t meldra_v_32 = meldra_v_31.length;
    /* valid/owner_move_after.meldra:20:11 i34 */
    uint64_t meldra_v_33 = meldra_v_29 + meldra_v_32;
    /* valid/owner_move_after.meldra:20:4 i35 */
    if (!meldra_v_31.live) meldra_panic_bytes_double_drop();
    if (meldra_v_31.data != NULL) { free(meldra_v_31.data); ++meldra_heap_frees; }
    meldra_v_31.data = NULL; meldra_v_31.length = 0; meldra_v_31.capacity = 0; meldra_v_31.live = false;
    return meldra_v_33;
}

static uint64_t meldra_fn_outer(meldra_bytes_view meldra_data_1, uint64_t meldra_state_2) {
meldra_bb1_entry: ;
    /* valid/owner_move_after.meldra:8:11 i1 */
    /* reborrow_argument: reborrow_argument:outer:8:11:leaf:data root=main.owner */
    /* valid/owner_move_after.meldra:8:11 i2 */
    uint64_t meldra_v_3 = meldra_fn_leaf(meldra_data_1, meldra_state_2);
    /* valid/owner_move_after.meldra:8:11 i3 */
