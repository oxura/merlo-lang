...
static uint64_t meldra_reborrow_before_allocations = 0;
...
static MELDRA_NOINLINE uint64_t meldra_fn_leaf(meldra_bytes_view meldra_data_1, uint64_t meldra_state_2);
...
static MELDRA_NOINLINE uint64_t meldra_fn_middle(meldra_bytes_view meldra_data_1, uint64_t meldra_state_2);
static MELDRA_NOINLINE uint64_t meldra_fn_outer(meldra_bytes_view meldra_data_1, uint64_t meldra_state_2);
static meldra_bytes meldra_fn_transfer(meldra_bytes meldra_data_1);

static MELDRA_NOINLINE uint64_t meldra_fn_leaf(meldra_bytes_view meldra_data_1, uint64_t meldra_state_2) {
    meldra_reborrow_leaf_data = meldra_data_1.data;
    meldra_reborrow_leaf_length = meldra_data_1.length;
meldra_bb1_entry: ;
    /* abi/reborrow.meldra:2:4 i1 */
    uint64_t meldra_v_3;
    /* abi/reborrow.meldra:2:4 i2 */
    meldra_v_3 = meldra_state_2;
    /* abi/reborrow.meldra:3:26 i3 */
    uint64_t meldra_v_4 = UINT64_C(0);
    /* abi/reborrow.meldra:3:29 i4 */
    uint64_t meldra_v_5 = meldra_data_1.length;
    /* abi/reborrow.meldra:3:4 i5 */
    uint64_t meldra_v_6;
    /* abi/reborrow.meldra:3:4 i6 */
    meldra_v_6 = meldra_v_4;
    goto meldra_bb2_for_header;
meldra_bb2_for_header: ;
    /* abi/reborrow.meldra:3:4 i7 */
    uint64_t meldra_v_7 = meldra_v_6;
    /* abi/reborrow.meldra:3:4 i8 */
    bool meldra_v_8 = meldra_v_7 < meldra_v_5;
    if (meldra_v_8) goto meldra_bb3_for_body; else goto meldra_bb4_for_exit;
meldra_bb3_for_body: ;
    /* abi/reborrow.meldra:4:20 i9 */
    uint64_t meldra_v_9 = meldra_v_3;
    /* abi/reborrow.meldra:4:37 i10 */
    uint64_t meldra_v_10 = meldra_v_6;
    /* abi/reborrow.meldra:4:32 i11 */
    uint64_t meldra_v_11 = meldra_data_1.length;
    /* abi/reborrow.meldra:4:32 i12 */
    ++meldra_bounds_checks;
    if (meldra_v_10 >= meldra_v_11) meldra_panic_bytes_bounds(meldra_v_10, meldra_v_11);
    /* abi/reborrow.meldra:4:32 i13 */
    uint64_t meldra_v_12 = (uint64_t)meldra_data_1.data[meldra_v_10];
    /* abi/reborrow.meldra:4:42 i14 */
    uint64_t meldra_v_13 = meldra_v_6;
    /* abi/reborrow.meldra:4:32 i15 */
    uint64_t meldra_v_14 = meldra_v_12 + meldra_v_13;
    /* abi/reborrow.meldra:4:46 i16 */
    uint64_t meldra_v_15 = UINT64_C(23);
    /* abi/reborrow.meldra:4:32 i17 */
    uint64_t meldra_v_16 = meldra_v_14 + meldra_v_15;
    /* abi/reborrow.meldra:4:20 i18 */
    uint64_t meldra_v_17 = meldra_v_9 ^ meldra_v_16;
    /* abi/reborrow.meldra:4:53 i19 */
    uint64_t meldra_v_18 = UINT64_C(1099511628211);
    /* abi/reborrow.meldra:4:19 i20 */
    uint64_t meldra_v_19 = meldra_v_17 * meldra_v_18;
    /* abi/reborrow.meldra:4:8 i21 */
    meldra_v_3 = meldra_v_19;
    /* abi/reborrow.meldra:3:4 i22 */
    uint64_t meldra_v_20 = meldra_v_6;
    /* abi/reborrow.meldra:3:4 i23 */
    uint64_t meldra_v_21 = UINT64_C(1);
    /* abi/reborrow.meldra:3:4 i24 */
    uint64_t meldra_v_22 = meldra_v_20 + meldra_v_21;
    /* abi/reborrow.meldra:3:4 i25 */
    meldra_v_6 = meldra_v_22;
    goto meldra_bb2_for_header;
meldra_bb4_for_exit: ;
    /* abi/reborrow.meldra:5:11 i26 */
...
meldra_bb4_for_exit: ;
    ...
    meldra_reborrow_owner_data = meldra_v_6.data;
    meldra_reborrow_owner_length = meldra_v_6.length;
    meldra_reborrow_root_data = meldra_v_28.data;
    meldra_reborrow_root_length = meldra_v_28.length;
    /* abi/reborrow.meldra:20:23 i28 */
    /* borrow_argument: borrow_argument:main:20:23:outer:data root=main.owner */
    /* abi/reborrow.meldra:20:23 i29 */
    meldra_reborrow_before_allocations = meldra_heap_allocations;
    meldra_reborrow_before_frees = meldra_heap_frees;
    meldra_reborrow_before_payload_copies = meldra_payload_copies;
    uint64_t meldra_v_29 = meldra_fn_outer(meldra_v_28, meldra_seed_2);
    meldra_reborrow_after_allocations = meldra_heap_allocations;
    meldra_reborrow_after_frees = meldra_heap_frees;
    meldra_reborrow_after_payload_copies = meldra_payload_copies;
    /* abi/reborrow.meldra:20:23 i30 */
    /* borrow_end: borrow_argument:main:20:23:outer:data root=main.owner */
    /* abi/reborrow.meldra:21:22 i31 */
    uint64_t meldra_v_30 = meldra_v_6.length;
    /* abi/reborrow.meldra:21:11 i32 */
    uint64_t meldra_v_31 = meldra_v_29 + meldra_v_30;
    /* abi/reborrow.meldra:21:4 i33 */
...
static MELDRA_NOINLINE uint64_t meldra_fn_middle(meldra_bytes_view meldra_data_1, uint64_t meldra_state_2) {
    meldra_reborrow_middle_data = meldra_data_1.data;
    meldra_reborrow_middle_length = meldra_data_1.length;
meldra_bb1_entry: ;
    /* abi/reborrow.meldra:8:11 i1 */
    /* reborrow_argument: reborrow_argument:middle:8:11:leaf:data root=main.owner */
    /* abi/reborrow.meldra:8:11 i2 */
    uint64_t meldra_v_3 = meldra_fn_leaf(meldra_data_1, meldra_state_2);
    /* abi/reborrow.meldra:8:11 i3 */
    /* reborrow_end: reborrow_argument:middle:8:11:leaf:data root=main.owner */
    return meldra_v_3;
}

static MELDRA_NOINLINE uint64_t meldra_fn_outer(meldra_bytes_view meldra_data_1, uint64_t meldra_state_2) {
    meldra_reborrow_outer_data = meldra_data_1.data;
    meldra_reborrow_outer_length = meldra_data_1.length;
meldra_bb1_entry: ;
    /* abi/reborrow.meldra:11:11 i1 */
    /* reborrow_argument: reborrow_argument:outer:11:11:middle:data root=main.owner */
    /* abi/reborrow.meldra:11:11 i2 */
    uint64_t meldra_v_3 = meldra_fn_middle(meldra_data_1, meldra_state_2);
    /* abi/reborrow.meldra:11:11 i3 */
