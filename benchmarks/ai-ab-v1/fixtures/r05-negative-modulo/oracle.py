...
CASES=[[{'mod': 5, 'value': -1}, 4], ({'mod': 6, 'value': -1}, 1), ({'mod': 6, 'value': -1}, 1)]
def check(workspace,arm):
 ...
 return {"case_id":'r05-negative-modulo',"passed":all(r["passed"] for r in results),"defect_case_passed":results[0]["passed"],"unaffected_cases_passed":all(r["passed"] for r in results[1:]),"cases":results}
