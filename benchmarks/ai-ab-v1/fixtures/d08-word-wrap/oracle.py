...
CASES=[['one two three four five', 'one two\nthree four\nfive'], ['one two three four five extra', 'one two\nthree four\nfive extra'], ['one two three four five', 'one two\nthree four\nfive']]
def check(workspace,arm):
 ...
 return {"case_id":"d08-word-wrap","passed":bool(results) and all(x["passed"] for x in results),"cases":results}
