...
# Contract: ok:<integer> yields a value; err:<code> must propagate a
# structured failure. Baseline defect: err payloads are swallowed.
CASES = [
    ('err:E42', {'ok': False, 'value': None, 'error': 'E42'}),
    ('ok:7', {'ok': True, 'value': 7, 'error': None}),
    ('ok:0', {'ok': True, 'value': 0, 'error': None}),
]
