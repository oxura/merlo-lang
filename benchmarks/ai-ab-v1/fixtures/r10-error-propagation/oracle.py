...
CASES=[[{'error': 'E42'}, {'error': 'E42', 'ok': False}], ({'error': 'E42x'}, {'ok': True, 'error': None}), ({'error': 'E42x'}, {'ok': True, 'error': None})]
def check(workspace,arm):
 ...
 return {"case_id":'r10-error-propagation',"passed":all(r["passed"] for r in results),"defect_case_passed":results[0]["passed"],"unaffected_cases_passed":all(r["passed"] for r in results[1:]),"cases":results}
