...
CASES=[['a/./b/../c//d', 'a/c/d'], ['a/./b/../c//d extra', 'a/c/d extra'], ['A/./b/../c//d', 'A/c/d']]
def check(workspace,arm):
 ...
 return {"case_id":"d05-path-normalize","passed":bool(results) and all(x["passed"] for x in results),"cases":results}
