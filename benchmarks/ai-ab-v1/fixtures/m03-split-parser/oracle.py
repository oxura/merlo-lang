...
TASK_ID = 'm03-split-parser'
CASES = [('op=migrate|items=1,2,3', [1, 2, 3]), ('op=migrate|items=4,10', [4, 10]), ('op=migrate|items=8,20,30,40', [8, 20, 30, 40])]
UNTOUCHED = [('op=legacy|items=5,6,7', [5, 6])]
INPUT_ENCODING = 'raw'
