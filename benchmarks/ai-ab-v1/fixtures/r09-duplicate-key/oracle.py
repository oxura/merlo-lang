...
# Contract: parse semicolon-separated integer key/value pairs and report the
# first key's final value. Baseline defect: duplicate keys incorrectly keep the first value.
CASES = [
    ('mode=1;mode=2', 2),
    ('mode=7;count=9', 7),
    ('count=9;mode=7', 9),
