...
CASES=[['2026-08-01T00:30:00+00:00', '2026-08-01'], ('2026-08-01T00:30:00+00:00 extra', '2026-08'), ('2026-08-01T00:30:00+00:00', '2026-08')]
def check(workspace,arm):
 ...
 return {"case_id":'r08-timezone-boundary',"passed":all(r["passed"] for r in results),"defect_case_passed":results[0]["passed"],"unaffected_cases_passed":all(r["passed"] for r in results[1:]),"cases":results}
