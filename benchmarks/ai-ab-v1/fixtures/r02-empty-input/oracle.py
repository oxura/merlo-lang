...
def check(workspace,arm):
 ...
 return {"case_id":"r02-empty-input","passed":all(r["passed"] for r in results),"defect_case_passed":results[0]["passed"],"unaffected_cases_passed":all(r["passed"] for r in results[1:]),"cases":results}
