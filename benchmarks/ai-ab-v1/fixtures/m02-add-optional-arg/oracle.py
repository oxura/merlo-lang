...
CASES = [
    ("op=migrate|name=Ada|prefix=Hi", {"message": "Hi Ada"}),
    ("op=migrate|name=Bo|prefix=Welcome", {"message": "Welcome Bo"}),
    ("op=migrate|name=Cy|prefix=Yo", {"message": "Yo Cy"}),
]
UNTOUCHED = [
    ("op=legacy|name=Dee|prefix=Legacy", {"message": "Hello Dee"}),
]
