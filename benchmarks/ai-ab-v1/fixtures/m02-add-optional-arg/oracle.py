...
CASES=[[{'operation': 'migrate', 'payload': {'name': 'Ada', 'prefix': 'Hi'}}, {'message': 'Hi Ada'}], [{'operation': 'migrate', 'payload': {'name': 'Adax', 'prefix': 'Hi'}}, {'message': 'Hi Adax'}], [{'operation': 'migrate', 'payload': {'name': 'Adax', 'prefix': 'Hi'}}, {'message': 'Hi Adax'}]]
UNTOUCHED=[({'operation': 'legacy', 'payload': {'name': 'Adax', 'prefix': 'Hi'}}, {'message': 'Hello Adax'})]
...
def check(workspace,arm):
 ...
 return {"case_id":'m02-add-optional-arg',"passed":all(migration) and all(untouched_ok),"migration_passed":migration,"unaffected_passed":untouched_ok,"cases":len(CASES),"unaffected_cases":len(UNTOUCHED)}
