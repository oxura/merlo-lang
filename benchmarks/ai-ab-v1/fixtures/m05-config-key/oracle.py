...
TASK_ID = 'm05-config-key'
CASES = [('op=migrate|timeout_ms=250', {'timeout': 250}), ('op=migrate|timeout_ms=1000', {'timeout': 1000}), ('op=migrate|timeout_ms=1', {'timeout': 1})]
UNTOUCHED = [('op=legacy|timeout=9|timeout_ms=99', {'timeout': 9})]
INPUT_ENCODING = 'raw'
