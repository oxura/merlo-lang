...
CASES=[[[{'kind': 'open'}, {'kind': 'close'}, {'kind': 'open'}], {'close': 1, 'open': 2}], [[{'kind': 'open'}, {'kind': 'close'}, {'kind': 'open'}], {'close': 1, 'open': 2}], [[{'kind': 'open'}, {'kind': 'close'}, {'kind': 'open'}, {'kind': 'open'}], {'close': 1, 'open': 3}]]
def check(workspace,arm):
 ...
 return {"case_id":"d03-ndjson-group","passed":bool(results) and all(x["passed"] for x in results),"cases":results}
