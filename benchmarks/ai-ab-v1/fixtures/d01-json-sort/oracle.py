...
CASES=[[[{'name': 'b', 'score': 2}, {'name': 'a', 'score': 1}, {'name': 'c', 'score': 2}], [{'name': 'a', 'score': 1}, {'name': 'b', 'score': 2}, {'name': 'c', 'score': 2}]], [[{'name': 'c', 'score': 2}, {'name': 'a', 'score': 1}, {'name': 'b', 'score': 2}], [{'name': 'a', 'score': 1}, {'name': 'b', 'score': 2}, {'name': 'c', 'score': 2}]], [[{'name': 'b', 'score': 2}, {'name': 'a', 'score': 1}, {'name': 'c', 'score': 2}, {'name': 'b', 'score': 2}], [{'name': 'a', 'score': 1}, {'name': 'b', 'score': 2}, {'name': 'b', 'score': 2}, {'name': 'c', 'score': 2}]]]
def check(workspace,arm):
 ...
 return {"case_id":"d01-json-sort","passed":bool(results) and all(x["passed"] for x in results),"cases":results}
