...
# Contract: compare two texts using an ASCII-only byte fold; non-ASCII bytes
# are preserved. Baseline defect: '[' is incorrectly treated as uppercase.
CASES = [
    ('[|{', False),
    ('Alpha|ALPHA', True),
    ('cafe|CAFE', True),
