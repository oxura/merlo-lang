...
CASES=[['Red blue red BLUE', {'blue': 2, 'red': 2}], ['Red blue red BLUE extra', {'blue': 2, 'extra': 1, 'red': 2}], ['Red blue red BLUE', {'blue': 2, 'red': 2}]]
def check(workspace,arm):
 ...
 return {"case_id":"d04-text-histogram","passed":bool(results) and all(x["passed"] for x in results),"cases":results}
