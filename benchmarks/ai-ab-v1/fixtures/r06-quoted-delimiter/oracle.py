...
# Contract: count comma-delimited fields; quotes should protect commas.
# Baseline defect: generic delimiter splitting ignores quote state.
CASES = [
    ('a,"b,c",d', 3),
    ('alpha,beta,gamma', 3),
    ('single', 1),
