...
CASES=[['a,"b,c",d', ['a', 'b,c', 'd']], ('a,"b,c",d extra', ['a', '"b', 'c"', 'd extra']), ('A,"b,c",d', ['A', '"b', 'c"', 'd'])]
def check(workspace,arm):
 ...
 return {"case_id":'r06-quoted-delimiter',"passed":all(r["passed"] for r in results),"defect_case_passed":results[0]["passed"],"unaffected_cases_passed":all(r["passed"] for r in results[1:]),"cases":results}
