...
static uint64_t meldra_fn_main(uint64_t meldra_scalar_1) {
meldra_bb1_entry: ;
    /* text-bytes-text.meldra:2:15 i1 */
    meldra_text meldra_v_2 = meldra_text_from_scalar(meldra_scalar_1);
    /* text-bytes-text.meldra:3:16 i2 */
    meldra_bytes meldra_v_3 = { meldra_v_2.data, meldra_v_2.length, meldra_v_2.capacity, true };
    meldra_v_2.data = NULL;
    meldra_v_2.length = 0;
    meldra_v_2.capacity = 0;
    meldra_v_2.live = false;
    /* text-bytes-text.meldra:4:38 i3 */
    meldra_bytes meldra_v_4 = meldra_v_3;
    meldra_v_3.data = NULL;
    meldra_v_3.length = 0;
    meldra_v_3.capacity = 0;
    meldra_v_3.live = false;
    /* text-bytes-text.meldra:4:23 i4 */
    /* Bytes -> Text ownership transfer; payload copy count is zero. */
    /* text-bytes-text.meldra:4:23 i5 */
    uint64_t meldra_utf8_error_i5 = UINT64_C(0);
    bool meldra_utf8_valid_i5 = meldra_utf8_validate(meldra_v_4.data, meldra_v_4.length, &meldra_utf8_error_i5);
    meldra_utf8_decode meldra_v_5 = {0};
    meldra_v_5.valid = meldra_utf8_valid_i5;
    meldra_v_5.error_offset = meldra_utf8_error_i5;
    if (meldra_v_5.valid) {
        meldra_v_5.text = (meldra_text){ meldra_v_4.data, meldra_v_4.length, meldra_v_4.capacity, true };
    } else {
    ...
    meldra_v_4.live = false;
    /* text-bytes-text.meldra:5:1 i6 */
    if (meldra_v_5.consumed) meldra_panic_utf8_decode_state();
    bool meldra_v_6 = meldra_v_5.valid;
    if (meldra_v_6) goto meldra_bb2_utf8_valid; else goto meldra_bb3_utf8_invalid;
meldra_bb2_utf8_valid: ;
    /* text-bytes-text.meldra:5:1 i7 */
    if (meldra_v_5.consumed || !meldra_v_5.valid) meldra_panic_utf8_decode_state();
    meldra_text meldra_v_7 = meldra_v_5.text;
    meldra_v_5.text = (meldra_text){0};
    meldra_v_5.consumed = true;
    /* text-bytes-text.meldra:7:19 i8 */
    meldra_bytes meldra_v_8 = { meldra_v_7.data, meldra_v_7.length, meldra_v_7.capacity, true };
    meldra_v_7.data = NULL;
    meldra_v_7.length = 0;
    meldra_v_7.capacity = 0;
    meldra_v_7.live = false;
    /* text-bytes-text.meldra:8:10 i9 */
    uint64_t meldra_v_9 = meldra_v_8.length;
    /* text-bytes-text.meldra:8:3 i14 */
    if (!meldra_v_8.live) meldra_panic_bytes_double_drop();
    if (meldra_v_8.data != NULL) { free(meldra_v_8.data); ++meldra_heap_frees; }
    meldra_v_8.data = NULL; meldra_v_8.length = 0; meldra_v_8.capacity = 0; meldra_v_8.live = false;
    return meldra_v_9;
meldra_bb3_utf8_invalid: ;
    /* text-bytes-text.meldra:5:1 i10 */
    if (meldra_v_5.consumed || meldra_v_5.valid) meldra_panic_utf8_decode_state();
    uint64_t meldra_v_10 = meldra_v_5.error_offset;
    /* text-bytes-text.meldra:5:1 i11 */
    if (meldra_v_5.consumed) meldra_panic_utf8_decode_state();
    if (meldra_v_5.valid && meldra_v_5.text.data != NULL) {
        free(meldra_v_5.text.data);
        ++meldra_heap_frees;
    }
    meldra_v_5.text = (meldra_text){0};
    meldra_v_5.consumed = true;
    /* text-bytes-text.meldra:10:25 i12 */
    uint64_t meldra_v_11 = UINT64_C(100);
    /* text-bytes-text.meldra:10:10 i13 */
    uint64_t meldra_v_12 = meldra_v_10 + meldra_v_11;
    /* text-bytes-text.meldra:10:3 i15 */
    if (!meldra_v_8.live) meldra_panic_bytes_double_drop();
    if (meldra_v_8.data != NULL) { free(meldra_v_8.data); ++meldra_heap_frees; }
    meldra_v_8.data = NULL; meldra_v_8.length = 0; meldra_v_8.capacity = 0; meldra_v_8.live = false;
    return meldra_v_12;
meldra_bb4_utf8_match_join: ;
    abort();
}
