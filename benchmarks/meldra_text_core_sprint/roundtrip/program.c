...
static uint64_t meldra_fn_main(uint64_t meldra_scalar_1) {
meldra_bb1_entry: ;
    /* text-roundtrip.meldra:2:14 i1 */
    meldra_text meldra_v_2 = meldra_text_from_scalar(meldra_scalar_1);
    /* text-roundtrip.meldra:3:18 i2 */
    meldra_text_view meldra_v_3 = { meldra_v_2.data, meldra_v_2.length };
    /* text-roundtrip.meldra:4:18 i3 */
    meldra_bytes_view meldra_v_4 = { meldra_v_3.data, meldra_v_3.length };
    /* text-roundtrip.meldra:5:18 i4 */
    uint64_t meldra_v_5 = meldra_v_4.length;
    /* text-roundtrip.meldra:5:1 i5 */
    /* TextView borrow_end: text_view:main:view:3:18 owner=main.text */
    /* text-roundtrip.meldra:6:16 i6 */
    meldra_bytes meldra_v_6 = { meldra_v_2.data, meldra_v_2.length, meldra_v_2.capacity, true };
    meldra_v_2.data = NULL;
    meldra_v_2.length = 0;
    meldra_v_2.capacity = 0;
    meldra_v_2.live = false;
    /* text-roundtrip.meldra:7:17 i7 */
    uint64_t meldra_v_7 = meldra_v_6.length;
    /* text-roundtrip.meldra:7:8 i8 */
    uint64_t meldra_v_8 = meldra_v_5 + meldra_v_7;
    /* text-roundtrip.meldra:7:1 i9 */
