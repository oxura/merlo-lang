...
static uint64_t meldra_fn_main(uint64_t meldra_n_1, uint64_t meldra_seed_2) {
meldra_bb1_entry: ;
    /* benchmarks/meldra_bytes_builder/correctness/unfinished_drop.meldra:2:28 i1 */
    ...
    /* benchmarks/meldra_bytes_builder/correctness/unfinished_drop.meldra:3:11 i2 */
    uint64_t meldra_v_4 = UINT64_C(0);
    /* benchmarks/meldra_bytes_builder/correctness/unfinished_drop.meldra:3:7 i3 */
    bool meldra_v_5 = meldra_n_1 > meldra_v_4;
    if (meldra_v_5) goto meldra_bb2_if_then; else goto meldra_bb3_if_else;
meldra_bb2_if_then: ;
    /* benchmarks/meldra_bytes_builder/correctness/unfinished_drop.meldra:4:28 i4 */
    uint64_t meldra_v_6 = UINT64_C(255);
    /* benchmarks/meldra_bytes_builder/correctness/unfinished_drop.meldra:4:21 i5 */
    uint64_t meldra_v_7 = meldra_seed_2 & meldra_v_6;
    /* benchmarks/meldra_bytes_builder/correctness/unfinished_drop.meldra:4:8 i6 */
    uint64_t meldra_v_8 = UINT64_C(1);
    /* benchmarks/meldra_bytes_builder/correctness/unfinished_drop.meldra:4:8 i7 */
    ...
    /* benchmarks/meldra_bytes_builder/correctness/unfinished_drop.meldra:4:8 i8 */
    /* conditional allocation event: required_exceeds_capacity */
    /* benchmarks/meldra_bytes_builder/correctness/unfinished_drop.meldra:4:8 i9 */
    /* conditional payload_copy event: required_exceeds_capacity */
    /* benchmarks/meldra_bytes_builder/correctness/unfinished_drop.meldra:4:8 i10 */
    /* conditional free event: required_exceeds_capacity */
    /* benchmarks/meldra_bytes_builder/correctness/unfinished_drop.meldra:4:8 i11 */
    if (meldra_v_3.state != UINT8_C(1)) meldra_panic_builder_state();
    if (meldra_v_3.active_views != 0) meldra_panic_builder_active_view();
...
meldra_bb3_if_else: ;
    goto meldra_bb4_if_join;
meldra_bb4_if_join: ;
    /* benchmarks/meldra_bytes_builder/correctness/unfinished_drop.meldra:5:11 i12 */
    if (meldra_v_3.state != UINT8_C(1)) meldra_panic_builder_state();
    uint64_t meldra_v_9 = meldra_v_3.length;
    /* benchmarks/meldra_bytes_builder/correctness/unfinished_drop.meldra:5:27 i13 */
    if (meldra_v_3.state != UINT8_C(1)) meldra_panic_builder_state();
    uint64_t meldra_v_10 = meldra_v_3.capacity;
    /* benchmarks/meldra_bytes_builder/correctness/unfinished_drop.meldra:5:11 i14 */
    uint64_t meldra_v_11 = meldra_v_9 + meldra_v_10;
    /* benchmarks/meldra_bytes_builder/correctness/unfinished_drop.meldra:5:4 i15 */
    if (meldra_v_3.state != UINT8_C(1)) meldra_panic_builder_state();
    if (meldra_v_3.active_views != 0) meldra_panic_builder_active_view();
