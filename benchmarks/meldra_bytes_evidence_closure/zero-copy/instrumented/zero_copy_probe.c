...
static MELDRA_NOINLINE uint64_t meldra_fn_main(uint64_t meldra_n_1, uint64_t meldra_start_2, uint64_t meldra_length_3);

static MELDRA_NOINLINE uint64_t meldra_fn_main(uint64_t meldra_n_1, uint64_t meldra_start_2, uint64_t meldra_length_3) {
meldra_bb1_entry: ;
    /* zero-copy.meldra:2:19 i1 */
    ...
    /* zero-copy.meldra:3:10 i2 */
    uint64_t meldra_v_5 = UINT64_C(0);
    /* zero-copy.meldra:3:15 i3 */
    uint64_t meldra_v_6 = UINT64_C(7);
    /* zero-copy.meldra:3:4 i4 */
    uint64_t meldra_v_7 = meldra_v_4.length;
    /* zero-copy.meldra:3:4 i5 */
    ++meldra_bounds_checks;
    if (meldra_v_5 >= meldra_v_7) meldra_panic_bytes_bounds(meldra_v_5, meldra_v_7);
    /* zero-copy.meldra:3:4 i6 */
    meldra_v_4.data[meldra_v_5] = (uint8_t)(meldra_v_6 & UINT64_C(255));
    /* zero-copy.meldra:4:22 i7 */
    if (meldra_start_2 > meldra_v_4.length || meldra_length_3 > meldra_v_4.length - meldra_start_2) meldra_panic_bytes_slice(meldra_start_2, meldra_length_3, meldra_v_4.length);
    uint64_t meldra_probe_alloc_before = meldra_heap_allocations; uint64_t meldra_probe_free_before = meldra_heap_frees;
    meldra_bytes_view meldra_v_8 = { meldra_v_4.data == NULL ? NULL : meldra_v_4.data + meldra_start_2, meldra_length_3 };
    fprintf(stderr, "MELDRA_VIEW_RELATION owner=%p view=%p offset=%" PRIu64  " alloc_before=%" PRIu64 " alloc_after=%" PRIu64  " free_before=%" PRIu64 " free_after=%" PRIu64 "\n", (void *)meldra_v_4.data, (void *)meldra_v_8.data, meldra_start_2, meldra_probe_alloc_before, meldra_heap_allocations, meldra_probe_free_before, meldra_heap_frees);
    /* zero-copy.meldra:5:4 i8 */
    uint64_t meldra_v_9 = meldra_v_8.length;
    /* zero-copy.meldra:5:4 i9 */
