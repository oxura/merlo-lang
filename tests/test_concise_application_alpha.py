...
from merlo.concise_application_milestone import (
    paired_corpus,
    run_concise_application_milestone,
)
from merlo.concise_precedence import (
    PRECEDENCE_TABLE,
    canonical_expression,
    roundtrip_expression,
    validate_precedence_corpus,
)
from merlo.script_arguments import (
    SCRIPT_ARGUMENT_TYPES,
    ScriptArgumentBoundary,
    ScriptArgumentError,
    parse_script_argument,
)
from merlo.concise_surface_freeze import (
...
from merlo.native_hir import (
    compile_native_hir,
    lower_native_hir_to_performance,
)
from merlo.performance_opt import optimize_mir
from merlo.semantic_surface import build_semantic_surface
...
ENTRY = Path("merlo/programs/concise_json/app/main.mlo")
