...
from merlo.productive_corpus import load_productive_corpus
from merlo.productive_corpus_execution import (
...
def test_merlo_compiler_emits_stable_invariant_diagnostic(family: str) -> None:
    corpus = load_productive_corpus(ROOT / "benchmarks/merlo_productive_corpus.json")
