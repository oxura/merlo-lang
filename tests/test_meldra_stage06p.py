...
from merlo.constant_knowledge_audit import (
    _meldra_shaped_c_source,
    _select_status as select_constant_knowledge_status,
)
from merlo.fair_memory_strategy import (
    _c_arena_source,
...
from merlo.non_elidable_region import (
    _select_decision as select_non_elidable_decision,
    reference_checksum as non_elidable_reference_checksum,
)
from merlo.native_bench import _compile_external
from merlo.native_differential import evaluate_mir, run_differential
from merlo.optimizer_evidence import run_optimizer_evidence
from merlo.native_hir import compile_native_hir
from merlo.stage06p_overlap import compare_stage04_overlap
from merlo.performance_frontend import (
    PerformanceCompileError,
    compile_performance_source,
)
from merlo.performance_opt import optimize_mir, region_ownership_lowering
