...
from research.archive.historical_protocol.merlo.coverage import SemanticCoverageReport
...
from research.archive.historical_protocol.merlo.model import Resolution
