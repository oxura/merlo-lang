...
from research.archive.historical_protocol.merlo.frontend_semantics import FrontendCompilation, HIRLocalBinding, HIRReference, HIRSymbol
from research.archive.historical_protocol.merlo.frontend_syntax import Declaration, Expression, MatchArm, Member, Statement
