...
from research.archive.historical_protocol.merlo.stage05p_freeze import STAGE05P_FREEZE_FILENAME
...
def write_stage05p_protocol(root: str | Path = ".") -> dict[str, Any]:
    ...
    (root_path / "tools" / "benchmarks" / "merlo" / "benchmarks" / STAGE05P_PROTOCOL_FILENAME).write_text(
