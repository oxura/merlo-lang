...
from research.archive.alpha1.merlo.frontend_hardening import run_frontend_hardening
from research.archive.alpha1.merlo.independent_corpus import verify_independent_corpus_lock
