...
def run_determinism_evidence(
    *,
    output_dir: str | Path = "tools/benchmarks/merlo/benchmarks/stage06p_determinism",
) -> dict[str, Any]:
...
def write_determinism_evidence(
    destination: str | Path = "tools/benchmarks/merlo/benchmarks/meldra_stage06p_determinism.json",
) -> dict[str, Any]:
