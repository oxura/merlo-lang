...
from research.archive.alpha1.merlo.frontend_bench import generate_paired_corpus
...
_LEGACY_ARTIFACTS = (
    "tools/benchmarks/merlo/benchmarks/meldra_external_coverage.json",
    "tools/benchmarks/merlo/benchmarks/meldra_external_results.json",
    "tools/benchmarks/merlo/benchmarks/meldra_external_validation.json",
    "tools/benchmarks/merlo/benchmarks/meldra_core_benchmark.json",
)
_NEW_LANGUAGE_ARTIFACTS = (
    "tools/benchmarks/merlo/benchmarks/meldra_stage04_frontend_benchmark.json",
    "tools/benchmarks/merlo/benchmarks/meldra_maximal_python.json",
    "tools/benchmarks/merlo/benchmarks/meldra_runtime_soundness.json",
    "tools/benchmarks/merlo/benchmarks/meldra_interface_locality.json",
    "tools/benchmarks/merlo/benchmarks/meldra_effect_context.json",
    "tools/benchmarks/merlo/benchmarks/meldra_capability_experiment.json",
)
...
def run_benchmark_integrity_report(root: str | Path = Path(__file__).resolve().parents[1]) -> BenchmarkIntegrityReport:
    ...
    locality = _load(root_path, "tools/benchmarks/merlo/benchmarks/meldra_interface_locality.json")
    context = _load(root_path, "tools/benchmarks/merlo/benchmarks/meldra_effect_context.json")
    capability = _load(root_path, "tools/benchmarks/merlo/benchmarks/meldra_capability_experiment.json")
    external = _load(root_path, "tools/benchmarks/merlo/benchmarks/meldra_external_coverage.json")
    projects = _load(root_path, "tools/benchmarks/merlo/benchmarks/meldra_external_projects.json")
