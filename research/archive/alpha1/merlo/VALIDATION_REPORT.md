...
Acquisition manifest: [`../tools/benchmarks/merlo/benchmarks/meldra_external_projects.json`](../tools/benchmarks/merlo/benchmarks/meldra_external_projects.json).
...
Task manifest: [`../tools/benchmarks/merlo/benchmarks/meldra_external_validation.json`](../tools/benchmarks/merlo/benchmarks/meldra_external_validation.json).
...
Raw result: [`../tools/benchmarks/merlo/benchmarks/meldra_external_results.json`](../tools/benchmarks/merlo/benchmarks/meldra_external_results.json).
...
Per-project rows и raw resolution counts находятся в [`../tools/benchmarks/merlo/benchmarks/meldra_hypothesis_pilot.json`](../tools/benchmarks/merlo/benchmarks/meldra_hypothesis_pilot.json).
...
Compact raw summary: [`../tools/benchmarks/merlo/benchmarks/meldra_git_identity_summary.json`](../tools/benchmarks/merlo/benchmarks/meldra_git_identity_summary.json).  
Manual adjudication: [`../tools/benchmarks/merlo/benchmarks/meldra_identity_manual_audit.json`](../tools/benchmarks/merlo/benchmarks/meldra_identity_manual_audit.json).
...
- [`../tools/benchmarks/merlo/benchmarks/meldra_external_projects.json`](../tools/benchmarks/merlo/benchmarks/meldra_external_projects.json) — exact corpus provenance;
- [`../tools/benchmarks/merlo/benchmarks/meldra_external_validation.json`](../tools/benchmarks/merlo/benchmarks/meldra_external_validation.json) — 500 task specs;
- [`../tools/benchmarks/merlo/benchmarks/meldra_external_results.json`](../tools/benchmarks/merlo/benchmarks/meldra_external_results.json) — 500 raw task outcomes и breakdowns;
- [`../tools/benchmarks/merlo/benchmarks/meldra_external_coverage.json`](../tools/benchmarks/merlo/benchmarks/meldra_external_coverage.json) — per-project semantic coverage и исправленные operation denominators;
- [`../tools/benchmarks/merlo/benchmarks/meldra_hypothesis_pilot.json`](../tools/benchmarks/merlo/benchmarks/meldra_hypothesis_pilot.json) — coverage/context/runtime/evidence/incremental/composition results;
- [`../tools/benchmarks/merlo/benchmarks/meldra_git_identity_summary.json`](../tools/benchmarks/merlo/benchmarks/meldra_git_identity_summary.json) — latest/deep Git metrics;
- [`../tools/benchmarks/merlo/benchmarks/meldra_identity_manual_audit.json`](../tools/benchmarks/merlo/benchmarks/meldra_identity_manual_audit.json) — ручная проверка спорных changed links;
- [`HASHING.md`](HASHING.md) — byte/revision/identity invariants.
- [`../tools/benchmarks/merlo/benchmarks/meldra_identity_review_queue.json`](../tools/benchmarks/merlo/benchmarks/meldra_identity_review_queue.json) — immutable independent-review queue;
- [`../research/archive/alpha1/benchmarks/meldra_validation_taxonomy.json`](../research/archive/alpha1/benchmarks/meldra_validation_taxonomy.json) — false-block Pareto и infrastructure breakdown;
- [`../tools/benchmarks/merlo/benchmarks/meldra_balanced_safe_pilot.json`](../tools/benchmarks/merlo/benchmarks/meldra_balanced_safe_pilot.json) — corrected source-product balanced planner pilot;
- [`../tools/benchmarks/merlo/benchmarks/meldra_external_apply_test_pilot.json`](../tools/benchmarks/merlo/benchmarks/meldra_external_apply_test_pilot.json) — isolated Pluggy apply/test/restore evidence;
- [`../tools/benchmarks/merlo/benchmarks/meldra_core_fixtures.json`](../tools/benchmarks/merlo/benchmarks/meldra_core_fixtures.json) — эквивалентные Python/Core programs;
- [`../tools/benchmarks/merlo/benchmarks/meldra_core_benchmark.json`](../tools/benchmarks/merlo/benchmarks/meldra_core_benchmark.json) — Core Semantics Lab measurements;
- [`../tools/benchmarks/merlo/benchmarks/meldra_0_5_gate.json`](../tools/benchmarks/merlo/benchmarks/meldra_0_5_gate.json) — решение и preregistered evidence gate.
...
- [`../tools/benchmarks/merlo/benchmarks/meldra_stage04_support_profile.json`](../tools/benchmarks/merlo/benchmarks/meldra_stage04_support_profile.json) — preregistered Python P0 scope;
- [`../tools/benchmarks/merlo/benchmarks/meldra_stage04_frontend_benchmark.json`](../tools/benchmarks/merlo/benchmarks/meldra_stage04_frontend_benchmark.json) — полный 40-program, 13-gate frontend result;
