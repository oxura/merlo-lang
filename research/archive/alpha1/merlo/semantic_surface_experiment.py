...
from research.archive.alpha1.merlo.semantic_surface import (
...
def run_semantic_surface_experiment(
    *,
    output_dir: str | Path = "tools/benchmarks/merlo/benchmarks/merlo_semantic_surface",
    report_path: str | Path = "tools/benchmarks/merlo/benchmarks/merlo_semantic_surface.json",
    repetitions: int = 9,
    warmups: int = 2,
) -> dict[str, Any]:
