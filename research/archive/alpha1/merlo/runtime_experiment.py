...
from research.archive.historical_protocol.merlo.evidence import dependency_revision
from research.archive.historical_protocol.merlo.model import EvidenceDependency, ProgramIR
