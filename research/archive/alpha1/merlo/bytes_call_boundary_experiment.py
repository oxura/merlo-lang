...
def run_bytes_call_boundary_experiment(
    *,
    output_dir: str | Path = "tools/benchmarks/merlo/benchmarks/meldra_bytes_call_boundary",
    report_path: str | Path = "tools/benchmarks/merlo/benchmarks/meldra_bytes_call_boundary.json",
) -> dict[str, Any]:
    ...
    report = {
        ...
        "preregistration": json.loads(Path("tools/benchmarks/merlo/benchmarks/meldra_bytes_call_boundary_preregistered.json").read_text(encoding="utf-8")),
        "self_skeptical_audit": json.loads(Path("tools/benchmarks/merlo/benchmarks/meldra_bytes_call_boundary_self_skeptical_audit.json").read_text(encoding="utf-8")),
