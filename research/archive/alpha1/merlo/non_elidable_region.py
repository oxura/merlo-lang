...
_OLD_ARTIFACT = Path("tools/benchmarks/merlo/benchmarks/meldra_fair_memory_strategy.json")
...
def run_non_elidable_region_benchmark(
    *,
    output_dir: str | Path = "tools/benchmarks/merlo/benchmarks/non_elidable_region",
    repetitions: int = 30,
    warmups: int = 5,
    n: int = DEFAULT_N,
    ...
    Path("tools/benchmarks/merlo/benchmarks/meldra_non_elidable_region.json").write_text(
        text, encoding="utf-8"
    )
    return report
