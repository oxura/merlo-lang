...
from .frontend_syntax import FrontendSyntaxError, parse_source
...
def _subprocess_digest(
    ...
    script = (
        ...
        "from merlo.frontend_semantics import compile_frontend;"
...
def run_frontend_hardening(root: str | Path = ".") -> FrontendHardeningReport:
    ...
    lock_path = root_path / "benchmarks" / "meldra_independent_corpus_lock.json"
