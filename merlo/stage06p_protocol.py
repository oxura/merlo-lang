...
def build_stage06p_protocol(root: str | Path = ".") -> dict[str, Any]:
    ...
    freeze = root_path / "benchmarks" / "meldra_stage05p_freeze_v2.json"
    return {
        ...
        "stage05p_freeze_v2": {
            "path": "benchmarks/meldra_stage05p_freeze_v2.json",
...
def write_stage06p_protocol(root: str | Path = ".") -> dict[str, Any]:
    ...
    (root_path / "benchmarks" / STAGE06P_PROTOCOL_FILENAME).write_text(
