...
from .native_c_backend import CEmitter, NativeBackendError, compile_c_source
...
def _compile_meldra_stage06(
    ...
    from .native_bench import _meldra_source
...
def run_stage06p_benchmark(
    *,
    output_dir: str | Path = "benchmarks/stage06p_benchmark",
