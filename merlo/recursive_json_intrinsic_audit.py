...
def run_recursive_json_intrinsic_audit(
    destination: str | Path = "benchmarks/meldra_recursive_json_intrinsic_audit.json",
) -> dict[str, Any]:
    ...
    text_streaming_artifact = repo_root / "benchmarks/meldra_text_streaming_core.json"
    report: dict[str, Any] = {
        ...
        "frozen_hashes": {
            ...
            "performance_frontend_sha256": _sha256_file(
                repo_root / "merlo/performance_frontend.py"
            ),
            "native_hir_sha256": _sha256_file(
                repo_root / "merlo/native_hir.py"
            ),
            "performance_mir_sha256": _sha256_file(
                repo_root / "merlo/performance_mir.py"
            ),
            "native_c_backend_sha256": _sha256_file(
                repo_root / "merlo/native_c_backend.py"
            ),
            "json_streaming_c_sha256": _sha256_file(
                repo_root / "merlo/json_streaming_c.py"
            ),
        },
        "limitations": [
