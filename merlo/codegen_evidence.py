...
from .native_bench import WORKLOADS, _c_source, _meldra_source
...
def run_codegen_evidence(
    *,
    output_dir: str | Path = "benchmarks/stage06p_codegen",
) -> dict[str, Any]:
...
def write_codegen_evidence(
    destination: str | Path = "benchmarks/meldra_stage06p_codegen.json",
) -> dict[str, Any]:
