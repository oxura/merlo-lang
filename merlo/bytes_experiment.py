...
def run_bytes_experiment(
    *,
    output_dir: str | Path = "benchmarks/meldra_bytes_experiment",
    report_path: str | Path = "benchmarks/meldra_bytes_experiment.json",
) -> dict[str, Any]:
