...
SCHEMA_VERSION = 1
CORPUS_PATH = Path("benchmarks/merlo_productive_ai_change_corpus.json")
...
_SOURCE_PATHS = (
    "merlo/productive_applications.py",
    "tests/test_productive_applications.py",
)
...
_TASKS = (
    _TaskTemplate(
        ...
        (
            "merlo/productive_applications.py::analyze_ndjson",
            "tests/test_productive_applications.py::test_ndjson_analyzer_filters_groups_and_reports_invalid_lines",
        ),
        (
            "merlo/productive_applications.py::aggregate_csv",
            "merlo/productive_applications.py::search_text",
            "merlo/productive_cli.py",
        ),
    ...
    _TaskTemplate(
        ...
        (
            "merlo/productive_applications.py::_text_lines",
            "tests/test_productive_applications.py::test_ndjson_analyzer_rejects_invalid_utf8",
        ),
        (
            "merlo/productive_applications.py::aggregate_csv",
            "merlo/productive_applications.py::search_text",
    ...
    _TaskTemplate(
        ...
        (
            "merlo/productive_applications.py::run_ndjson_cli",
            "tests/test_productive_applications.py::test_productive_cli_entrypoints_execute_each_application",
        ),
        (
            "merlo/productive_applications.py::run_csv_cli",
            "merlo/productive_applications.py::run_grep_cli",
            "merlo/productive_cli.py::parse_productive_cli",
        ),
    ...
    _TaskTemplate(
        ...
        (
            "merlo/productive_applications.py::analyze_ndjson::duration handling",
            "tests/test_productive_applications.py::test_ndjson_analyzer_filters_groups_and_reports_invalid_lines",
        ),
        (
            "merlo/productive_applications.py::aggregate_csv",
    ...
    _TaskTemplate(
        ...
        (
            "merlo/productive_applications.py::_checked_add",
            "tests/test_productive_applications.py::ndjson uint64 overflow regression",
        ),
        (
            "merlo/productive_applications.py::_checked_multiply",
            "merlo/productive_applications.py::aggregate_csv",
            "merlo/productive_applications.py::search_text",
        ),
    ...
    _TaskTemplate(
        ...
        ("level error=2\\n", "service api=1\\nservice db=1\\n"),
        (
            "merlo/productive_applications.py::analyze_ndjson::group ordering",
            "tests/test_productive_applications.py::test_ndjson_analyzer_filters_groups_and_reports_invalid_lines",
        ),
        (
            "merlo/deterministic_map.py",
            "merlo/productive_applications.py::aggregate_csv",
            "merlo/productive_applications.py::search_text",
        ),
    ...
    _TaskTemplate(
        ...
        (
            "merlo/productive_applications.py::aggregate_csv",
            "tests/test_productive_applications.py::test_csv_aggregator_supports_quotes_and_checked_revenue",
        ),
        (
            "merlo/productive_applications.py::analyze_ndjson",
            "merlo/productive_applications.py::search_text",
    ...
    _TaskTemplate(
        ...
        (
            "merlo/productive_applications.py::_checked_multiply",
            "tests/test_productive_applications.py::test_csv_aggregator_detects_uint64_overflow",
        ),
        (
            "merlo/productive_applications.py::_checked_add",
            "merlo/productive_applications.py::analyze_ndjson",
    ...
    _TaskTemplate(
        ...
        ("valid=2\\n", "invalid=2\\n", "quantity=5\\n", "revenue_cents=850\\n"),
        (
            "merlo/productive_applications.py::aggregate_csv::row validation",
            "tests/test_productive_applications.py::test_csv_aggregator_supports_quotes_and_checked_revenue",
        ),
        (
            "merlo/productive_applications.py::analyze_ndjson",
    ...
    _TaskTemplate(
        ...
        (
            "merlo/productive_applications.py::aggregate_csv::group ordering",
            "tests/test_productive_applications.py::test_csv_aggregator_supports_quotes_and_checked_revenue",
        ),
        (
            "merlo/deterministic_map.py",
    ...
    _TaskTemplate(
        ...
        (
            "merlo/productive_applications.py::aggregate_csv::delimiter validation",
            "tests/test_productive_applications.py::csv invalid delimiter regression",
        ),
        (
            "merlo/productive_applications.py::analyze_ndjson",
            "merlo/productive_applications.py::search_text",
    ...
    _TaskTemplate(
        ...
        (
            "merlo/productive_applications.py::_ascii_lower",
            "tests/test_productive_applications.py::test_grep_search_exact_ascii_ignore_case_and_unterminated_line",
        ),
        (
            "merlo/productive_applications.py::analyze_ndjson",
            "merlo/productive_applications.py::aggregate_csv",
    ...
    _TaskTemplate(
        ...
        ("3\\n",),
        (
            "merlo/productive_applications.py::search_text::count_only output",
            "tests/test_productive_applications.py::test_grep_search_exact_ascii_ignore_case_and_unterminated_line",
        ),
        (
            "merlo/productive_applications.py::analyze_ndjson",
    ...
    _TaskTemplate(
        ...
        (
            "merlo/productive_applications.py::_text_lines",
            "tests/test_productive_applications.py::test_grep_search_rejects_invalid_utf8",
        ),
        (
            "merlo/productive_applications.py::analyze_ndjson",
            "merlo/productive_applications.py::aggregate_csv",
    ...
    _TaskTemplate(
        ...
        (
            "merlo/productive_applications.py::run_grep_cli::error mapping",
            "tests/test_productive_applications.py::test_productive_cli_entrypoints_return_typed_argument_errors",
        ),
        (
            "merlo/productive_applications.py::run_ndjson_cli",
            "merlo/productive_applications.py::run_csv_cli",
            "merlo/productive_cli.py::parse_productive_cli::grammar",
        ),
    ...
    _TaskTemplate(
        ...
        (
            "merlo/productive_applications.py::search_text::no-match branch",
            "tests/test_productive_applications.py::grep no-match regression",
        ),
        (
            "merlo/productive_applications.py::analyze_ndjson",
            "merlo/productive_applications.py::aggregate_csv",
