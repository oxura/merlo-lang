...
_INTRINSIC_ROWS = (
    ...
    _signature("fs.open_read", ("Path",), "Result[FileReader,AppError]", "fs.read", parameter_ownership=("borrow",), result_ownership="owned"),
    _signature("fs.read", ("Path",), "Result[Bytes,AppError]", "fs.read", parameter_ownership=("borrow",), result_ownership="owned"),
    _signature("fs.read_text", ("Path",), "Result[Text,AppError]", "fs.read", parameter_ownership=("borrow",), result_ownership="owned"),
    _signature("fs.read_chunk", ("FileReader", "UInt64"), "Result[Bytes,AppError]", "fs.read", parameter_ownership=("borrow_mut", "value"), result_ownership="owned"),
    _signature("fs.open_write", ("Path",), "Result[FileReader,AppError]", "fs.write", parameter_ownership=("borrow",), result_ownership="owned"),
    _signature("fs.write", ("Path", "BytesView"), "Result[Unit,AppError]", "fs.write", parameter_ownership=("borrow", "borrow")),
    _signature("fs.write_text", ("Path", "TextView"), "Result[Unit,AppError]", "fs.write", parameter_ownership=("borrow", "borrow")),
    _signature("fs.write_chunk", ("FileReader", "BytesView"), "Result[Unit,AppError]", "fs.write", parameter_ownership=("borrow_mut", "borrow")),
    _signature("fs.close", ("FileReader",), "Result[Unit,AppError]", "fs.write", parameter_ownership=("consuming",)),
