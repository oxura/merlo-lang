...
from .bytes_borrowed_return import (
...
from .bytes_reborrow_experiment import _function_source
...
def run_bytes_borrowed_return_experiment(
    *,
    output_dir: str | Path = "benchmarks/meldra_bytes_borrowed_return",
    report_path: str | Path = "benchmarks/meldra_bytes_borrowed_return.json",
) -> dict[str, Any]:
    ...
    report = {
        ...
        "preregistration": json.loads(
            Path(
                "benchmarks/meldra_bytes_borrowed_return_preregistered.json"
            ).read_text(encoding="utf-8")
        ),
        "self_skeptical_audit": json.loads(
            Path(
                "benchmarks/meldra_bytes_borrowed_return_self_skeptical_audit.json"
            ).read_text(encoding="utf-8")
        ),
        "contracts": {
