...
from .bytes_experiment import _compile_sanitized, _disassembly
from .bytes_reborrow import (
...
def run_bytes_reborrow_experiment(
    *,
    output_dir: str | Path = "benchmarks/meldra_bytes_reborrow",
    report_path: str | Path = "benchmarks/meldra_bytes_reborrow.json",
) -> dict[str, Any]:
    ...
    report = {
        ...
        "preregistration": json.loads(Path("benchmarks/meldra_bytes_reborrow_preregistered.json").read_text(encoding="utf-8")),
        "self_skeptical_audit": json.loads(Path("benchmarks/meldra_bytes_reborrow_self_skeptical_audit.json").read_text(encoding="utf-8")),
        "contracts": {
