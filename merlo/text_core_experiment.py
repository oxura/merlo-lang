...
from .builder_call_boundary_experiment import (
...
from .native_differential import evaluate_hir, evaluate_mir
...
def _cache_snapshot(root: Path) -> dict[str, dict[str, Any]]:
    names = (
        "benchmarks/meldra_bytes_experiment.json",
        "benchmarks/meldra_bytes_call_boundary.json",
        "benchmarks/meldra_bytes_reborrow.json",
        "benchmarks/meldra_bytes_borrowed_return.json",
        "benchmarks/meldra_bytes_builder.json",
    )
    snapshot = {}
    for name in names:
        path = root / name
...
def run_text_core_experiment(
    *,
    output_dir: str | Path = "benchmarks/meldra_text_core_sprint",
    report_path: str | Path = "benchmarks/meldra_text_core_sprint.json",
) -> dict[str, Any]:
