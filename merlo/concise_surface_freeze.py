...
from .concise_application import CONCISE_SURFACE_VERSION
from .concise_precedence import PRECEDENCE_TABLE
...
def write_concise_surface_freeze(root: str | Path = ".") -> Path:
    path = Path(root).resolve() / "benchmarks" / CONCISE_SURFACE_FREEZE_FILENAME
    path.write_text(
