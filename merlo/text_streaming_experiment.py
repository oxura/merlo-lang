...
_PREDECESSORS = (
    ...
    "benchmarks/meldra_text_builder.json",
...
def run_text_streaming_experiment(
    *,
    output_dir: str | Path = "benchmarks/meldra_text_streaming_core",
    report_path: str | Path = "benchmarks/meldra_text_streaming_core.json",
) -> dict[str, Any]:
    started = time.perf_counter()
