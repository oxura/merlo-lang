...
`benchmarks/meldra_stage05p_freeze_v2.json` freezes Stage 0.5P before Stage 0.6P changes. Stage 0.5P and the Python sidecar remain `CRITICAL_FIXES_ONLY`. A Stage 0.5P defect requires a failing regression, a version increment, and preserved before/after evidence.
