...
from .frontend_bench import NegativeCase, generate_negative_cases
...
def _paths(root: Path) -> tuple[Path, Path]:
    return (
        root / "benchmarks" / INDEPENDENT_CORPUS_FILENAME,
        root / "benchmarks" / INDEPENDENT_CORPUS_LOCK_FILENAME,
    )
