...
_INSTANCE_METHOD_ROWS = (
    ...
    InstanceMethodSignature(
        ...
        (),
        "T",
        result_ownership="payload_move",
        effects=("may_fail",),
        representation_lowering="option_unwrap_move",
    ),
    InstanceMethodSignature(
        "Result[T,E]",
        "is_ok",
    ...
    InstanceMethodSignature(
        ...
        result_ownership="payload_move",
        effects=("may_fail",),
        representation_lowering="result_unwrap_move",
    ),
    InstanceMethodSignature(
        "Result[T,E]",
        "unwrap_err",
        ...
        result_ownership="payload_move",
        effects=("may_fail",),
        representation_lowering="result_unwrap_err_move",
    ),
    InstanceMethodSignature(
        "Vec[T]",
        "clone",
