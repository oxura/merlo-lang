...
Merlo `0.1.0-alpha.2` is the current Linux x86-64 prerelease. The bootstrap
compiler requires Python 3.11 or newer and has no third-party Python runtime
dependencies; native builds use a C11-capable Clang or GCC and synchronous I/O.
