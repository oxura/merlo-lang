...
bound to the alpha2 baseline but remain unexecuted pending the parent’s frozen
external core anchor, immutable container, and provider locks. No model call
has occurred.
